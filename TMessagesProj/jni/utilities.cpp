...
extern "C" JNIEXPORT jstring Java_tglive_fqrs_app_Utilities_readlink(JNIEnv *env, jclass clazz, jstring path) {
...
extern "C" JNIEXPORT jstring Java_tglive_fqrs_app_Utilities_readlinkFd(JNIEnv *env, jclass clazz, int fd) {
...
Java_tglive_fqrs_app_Utilities_setupNativeCrashesListener(JNIEnv *env, jclass clazz,
                                                                 jstring path) {
