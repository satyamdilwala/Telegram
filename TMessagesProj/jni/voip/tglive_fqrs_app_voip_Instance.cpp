#include "tglive_fqrs_app_voip_Instance.h"
...
public:
    ...
    void call(JNIEnv *env, jobjectArray audioSsrcs) {
        ...
        jclass clz = env->FindClass("tglive/fqrs/app/voip/VoIPService$RequestedParticipant");
...
NetworkType parseNetworkType(jint networkType) {
    switch (networkType) {
        case tglive_fqrs_app_voip_Instance_NET_TYPE_GPRS:
            return NetworkType::Gprs;
        case tglive_fqrs_app_voip_Instance_NET_TYPE_EDGE:
            return NetworkType::Edge;
        case tglive_fqrs_app_voip_Instance_NET_TYPE_3G:
            return NetworkType::ThirdGeneration;
        case tglive_fqrs_app_voip_Instance_NET_TYPE_HSPA:
            return NetworkType::Hspa;
        case tglive_fqrs_app_voip_Instance_NET_TYPE_LTE:
            return NetworkType::Lte;
        case tglive_fqrs_app_voip_Instance_NET_TYPE_WIFI:
            return NetworkType::WiFi;
        case tglive_fqrs_app_voip_Instance_NET_TYPE_ETHERNET:
            return NetworkType::Ethernet;
        case tglive_fqrs_app_voip_Instance_NET_TYPE_OTHER_HIGH_SPEED:
            return NetworkType::OtherHighSpeed;
        case tglive_fqrs_app_voip_Instance_NET_TYPE_OTHER_LOW_SPEED:
            return NetworkType::OtherLowSpeed;
        case tglive_fqrs_app_voip_Instance_NET_TYPE_DIALUP:
            return NetworkType::Dialup;
        case tglive_fqrs_app_voip_Instance_NET_TYPE_OTHER_MOBILE:
...
DataSaving parseDataSaving(JNIEnv *env, jint dataSaving) {
    switch (dataSaving) {
        case tglive_fqrs_app_voip_Instance_DATA_SAVING_NEVER:
            return DataSaving::Never;
        case tglive_fqrs_app_voip_Instance_DATA_SAVING_MOBILE:
            return DataSaving::Mobile;
        case tglive_fqrs_app_voip_Instance_DATA_SAVING_ALWAYS:
            return DataSaving::Always;
        case tglive_fqrs_app_voip_Instance_DATA_SAVING_ROAMING:
...
EndpointType parseEndpointType(JNIEnv *env, jint endpointType) {
    switch (endpointType) {
        case tglive_fqrs_app_voip_Instance_ENDPOINT_TYPE_INET:
            return EndpointType::Inet;
        case tglive_fqrs_app_voip_Instance_ENDPOINT_TYPE_LAN:
            return EndpointType::Lan;
        case tglive_fqrs_app_voip_Instance_ENDPOINT_TYPE_TCP_RELAY:
            return EndpointType::TcpRelay;
        case tglive_fqrs_app_voip_Instance_ENDPOINT_TYPE_UDP_RELAY:
...
jint asJavaState(const State &state) {
    switch (state) {
        case State::WaitInit:
            return tglive_fqrs_app_voip_Instance_STATE_WAIT_INIT;
        case State::WaitInitAck:
            return tglive_fqrs_app_voip_Instance_STATE_WAIT_INIT_ACK;
        case State::Established:
            return tglive_fqrs_app_voip_Instance_STATE_ESTABLISHED;
        case State::Failed:
            return tglive_fqrs_app_voip_Instance_STATE_FAILED;
        case State::Reconnecting:
            return tglive_fqrs_app_voip_Instance_STATE_RECONNECTING;
    }
}
...
void initWebRTC(JNIEnv *env) {
    ...
    NativeInstanceClass = static_cast<jclass>(env->NewGlobalRef(env->FindClass("tglive/fqrs/app/voip/NativeInstance")));
    DEBUG_REF("TrafficStatsClass");
    TrafficStatsClass = static_cast<jclass>(env->NewGlobalRef(env->FindClass("tglive/fqrs/app/voip/Instance$TrafficStats")));
    DEBUG_REF("FingerprintClass");
    FingerprintClass = static_cast<jclass>(env->NewGlobalRef(env->FindClass("tglive/fqrs/app/voip/Instance$Fingerprint")));
    DEBUG_REF("FinalStateClass");
    FinalStateClass = static_cast<jclass>(env->NewGlobalRef(env->FindClass("tglive/fqrs/app/voip/Instance$FinalState")));
    FinalStateInitMethod = env->GetMethodID(FinalStateClass, "<init>", "([BLjava/lang/String;Ltglive/fqrs/app/voip/Instance$TrafficStats;Z)V");
}

extern "C"
JNIEXPORT jlong JNICALL Java_tglive_fqrs_app_voip_NativeInstance_makeGroupNativeInstance(JNIEnv *env, jclass clazz, jobject instanceObj, jstring logFilePath, jboolean highQuality, jlong videoCapturer, jboolean screencast, jboolean noiseSupression, jboolean conference) {
    initWebRTC(env);
...
extern "C" JNIEXPORT jbyteArray JNICALL Java_tglive_fqrs_app_voip_GroupCallMessagesController_groupCallMessageDecryptImpl(
...
extern "C" JNIEXPORT jbyteArray JNICALL Java_tglive_fqrs_app_voip_GroupCallMessagesController_groupCallMessageEncryptImpl(
        JNIEnv *env, jclass clazz,
        jlong callId,
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_setJoinResponsePayload(JNIEnv *env, jobject obj, jstring payload) {
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_prepareForStream(JNIEnv *env, jobject obj, jboolean isRtmpStream) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_resetGroupInstance(JNIEnv *env, jobject obj, jboolean set, jboolean disconnect) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_setNoiseSuppressionEnabled(JNIEnv *env, jobject obj, jboolean enabled) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT jlong JNICALL Java_tglive_fqrs_app_voip_NativeInstance_addIncomingVideoOutput(JNIEnv *env, jobject obj, jint quality, jstring endpointId, jobjectArray ssrcGroups, jobject remoteSink, jlong userId) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance == nullptr) {
        return 0;
    }
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_removeIncomingVideoOutput(JNIEnv *env, jobject obj, jlong nativeRemoteSink) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_setVideoEndpointQuality(JNIEnv *env, jobject obj, jstring endpointId, jint quality) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT jlong JNICALL Java_tglive_fqrs_app_voip_NativeInstance_makeNativeInstance(
    JNIEnv *env, jclass clazz,
    jstring version,
    jobject instanceObj,
    jobject config,
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_setGlobalServerConfig(JNIEnv *env, jobject obj, jstring serverConfigJson) {
    SetLegacyGlobalServerConfig(tgvoip::jni::JavaStringToStdString(env, serverConfigJson));
}

extern "C"
JNIEXPORT jstring JNICALL Java_tglive_fqrs_app_voip_NativeInstance_getVersion(JNIEnv *env, jobject obj) {
    return env->NewStringUTF(tgvoip::VoIPController::GetVersion());
}

extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_setBufferSize(JNIEnv *env, jobject obj, jint size) {
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_setNetworkType(JNIEnv *env, jobject obj, jint networkType) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_setMuteMicrophone(JNIEnv *env, jobject obj, jboolean muteMicrophone) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_setVolume(JNIEnv *env, jobject obj, jint ssrc, jdouble volume) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance != nullptr) {
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_setAudioOutputGainControlEnabled(JNIEnv *env, jobject obj, jboolean enabled) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance == nullptr || instance->nativeInstance == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_setEchoCancellationStrength(JNIEnv *env, jobject obj, jint strength) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance == nullptr || instance->nativeInstance == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT jstring JNICALL Java_tglive_fqrs_app_voip_NativeInstance_getLastError(JNIEnv *env, jobject obj) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance == nullptr || instance->nativeInstance == nullptr) {
        return nullptr;
    }
...
extern "C"
JNIEXPORT jstring JNICALL Java_tglive_fqrs_app_voip_NativeInstance_getDebugInfo(JNIEnv *env, jobject obj) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance == nullptr || instance->nativeInstance == nullptr) {
        return nullptr;
    }
...
extern "C"
JNIEXPORT jlong JNICALL Java_tglive_fqrs_app_voip_NativeInstance_getPreferredRelayId(JNIEnv *env, jobject obj) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance == nullptr || instance->nativeInstance == nullptr) {
        return 0;
    }
...
extern "C"
JNIEXPORT jobject JNICALL Java_tglive_fqrs_app_voip_NativeInstance_getTrafficStats(JNIEnv *env, jobject obj) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance == nullptr || instance->nativeInstance == nullptr) {
        return nullptr;
    }
...
extern "C"
JNIEXPORT jbyteArray JNICALL Java_tglive_fqrs_app_voip_NativeInstance_getPersistentState(JNIEnv *env, jobject obj) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance == nullptr || instance->nativeInstance == nullptr) {
        return nullptr;
    }
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_stopNative(JNIEnv *env, jobject obj) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance == nullptr || instance->nativeInstance == nullptr) {
        return;
    }
    instance->nativeInstance->stop([instance](const FinalState& finalState) {
        ...
        env->CallVoidMethod(globalRef, env->GetMethodID(NativeInstanceClass, "onStop", "(Ltglive/fqrs/app/voip/Instance$FinalState;)V"), asJavaFinalState(env, finalState));
        delete instance;
    });
}

extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_stopGroupNative(JNIEnv *env, jobject obj) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_onStreamPartAvailable(JNIEnv *env, jobject obj, jlong ts, jobject byteBuffer, jint size, jlong responseTs, jint videoChannel, jint quality) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_onMediaDescriptionAvailable(JNIEnv *env, jobject obj, jlong taskPtr, jobjectArray arr) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT jlong JNICALL Java_tglive_fqrs_app_voip_NativeInstance_createVideoCapturer(JNIEnv *env, jclass clazz, jobject localSink, jint type) {
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_activateVideoCapturer(JNIEnv *env, jobject obj, jlong videoCapturer) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_clearVideoCapturer(JNIEnv *env, jobject obj) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->nativeInstance) {
        instance->nativeInstance->setVideoCapture(nullptr);
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_destroyVideoCapturer(JNIEnv *env, jclass clazz, jlong videoCapturer) {
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_switchCameraCapturer(JNIEnv *env, jclass clazz, jlong videoCapturer, jboolean front) {
    auto* captureHolder = reinterpret_cast<std::shared_ptr<tgcalls::VideoCaptureInterface>*>(videoCapturer);
    auto capturer = *captureHolder;
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_setVideoStateCapturer(JNIEnv *env, jclass clazz, jlong videoCapturer, jint videoState) {
    auto* captureHolder = reinterpret_cast<std::shared_ptr<tgcalls::VideoCaptureInterface>*>(videoCapturer);
    auto capturer = *captureHolder;
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_switchCamera(JNIEnv *env, jobject obj, jboolean front) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->_videoCapture == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT jboolean JNICALL Java_tglive_fqrs_app_voip_NativeInstance_hasVideoCapturer(JNIEnv *env, jobject obj) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->_videoCapture == nullptr) {
        return JNI_FALSE;
    }
...
extern "C"
JNIEXPORT void Java_tglive_fqrs_app_voip_NativeInstance_setVideoState(JNIEnv *env, jobject obj, jint state) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_setupOutgoingVideo(JNIEnv *env, jobject obj, jobject localSink, jint type) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_setupOutgoingVideoCreated(JNIEnv *env, jobject obj, jlong videoCapturer) {
    if (videoCapturer == 0) {
        return;
    }
    auto* captureHolder = reinterpret_cast<std::shared_ptr<tgcalls::VideoCaptureInterface>*>(videoCapturer);
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_onSignalingDataReceive(JNIEnv *env, jobject obj, jbyteArray value) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance == nullptr || instance->nativeInstance == nullptr) {
        return;
    }
...
extern "C"
JNIEXPORT void JNICALL Java_tglive_fqrs_app_voip_NativeInstance_onRequestTimeComplete(JNIEnv *env, jobject obj, jlong taskPtr, jlong currentTime) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance == nullptr) {
        return;
    }
...
Java_tglive_fqrs_app_voip_NativeInstance_setConferenceCallId(JNIEnv *env, jobject obj,
                                                                    jlong call_id) {
    InstanceHolder *instance = getInstanceHolder(env, obj);
    if (instance->groupNativeInstance == nullptr) {
...
Java_tglive_fqrs_app_voip_NativeInstance_getAllVersions(JNIEnv* env) {
