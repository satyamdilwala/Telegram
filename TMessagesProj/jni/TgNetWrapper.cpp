...
static const char *NativeByteBufferClassPathName = "tglive/fqrs/app/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "tglive/fqrs/app/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_checkProxy", "(ILjava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ltglive/fqrs/app/tgnet/RequestTimeDelegate;)J", (void *) checkProxy},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestTimeDelegate = (jclass) env->NewGlobalRef(env->FindClass("tglive/fqrs/app/tgnet/RequestTimeDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("tglive/fqrs/app/tgnet/ConnectionsManager"));
