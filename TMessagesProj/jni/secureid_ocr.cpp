...
extern "C" JNIEXPORT jintArray Java_tglive_fqrs_app_MrzRecognizer_findCornerPoints(JNIEnv* env, jclass clasz, jobject bitmap){
...
extern "C" JNIEXPORT jobjectArray Java_tglive_fqrs_app_MrzRecognizer_binarizeAndFindCharacters(JNIEnv* env, jclass clasz, jobject inBmp, jobject outBmp){
...
extern "C" JNIEXPORT jstring Java_tglive_fqrs_app_MrzRecognizer_performRecognition(JNIEnv* env, jclass clasz, jobject bitmap, jint numRows, jint numCols, jobject jAssetManager){
...
extern "C" JNIEXPORT void Java_tglive_fqrs_app_MrzRecognizer_setYuvBitmapPixels(JNIEnv* env, jclass clasz, jobject bitmap, jbyteArray jpixels){
