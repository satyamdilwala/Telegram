...
extern "C" JNIEXPORT void JNICALL Java_tglive_fqrs_app_ui_Components_AnimatedFileDrawable_getVideoInfo(JNIEnv *env, jclass clazz, jint sdkVersion, jstring src, jintArray data) {
...
extern "C" JNIEXPORT jlong JNICALL Java_tglive_fqrs_app_ui_Components_AnimatedFileDrawable_createDecoder(JNIEnv *env, jclass clazz, jstring src, jintArray data, jint account, jlong streamFileSize, jobject stream, jboolean preview) {
    VideoInfo *info = new VideoInfo();
...
extern "C" JNIEXPORT void JNICALL Java_tglive_fqrs_app_ui_Components_AnimatedFileDrawable_destroyDecoder(JNIEnv *env, jclass clazz, jlong ptr) {
    if (ptr == NULL) {
        return;
    }
...
extern "C" JNIEXPORT void JNICALL Java_tglive_fqrs_app_ui_Components_AnimatedFileDrawable_stopDecoder(JNIEnv *env, jclass clazz, jlong ptr) {
    if (ptr == NULL) {
        return;
    }
    VideoInfo *info = (VideoInfo *) (intptr_t) ptr;
...
extern "C" JNIEXPORT void JNICALL Java_tglive_fqrs_app_ui_Components_AnimatedFileDrawable_prepareToSeek(JNIEnv *env, jclass clazz, jlong ptr) {
    if (ptr == NULL) {
        return;
    }
    VideoInfo *info = (VideoInfo *) (intptr_t) ptr;
...
extern "C" JNIEXPORT void JNICALL Java_tglive_fqrs_app_ui_Components_AnimatedFileDrawable_seekToMs(JNIEnv *env, jclass clazz, jlong ptr, jlong ms, jintArray data, jboolean precise) {
    if (ptr == NULL) {
        return;
    }
    VideoInfo *info = (VideoInfo *) (intptr_t) ptr;
...
extern "C" JNIEXPORT int JNICALL Java_tglive_fqrs_app_ui_Components_AnimatedFileDrawable_getFrameAtTime(JNIEnv *env, jclass clazz, jlong ptr, jlong ms, jobject bitmap, jintArray data, jint stride) {
...
extern "C" JNIEXPORT jint JNICALL Java_tglive_fqrs_app_ui_Components_AnimatedFileDrawable_getVideoFrame(JNIEnv *env, jclass clazz, jlong ptr, jobject bitmap, jintArray data, jint stride, jboolean preview, jfloat start_time, jfloat end_time, jboolean loop) {
    if (ptr == NULL) {
        return 0;
    }
...
extern "C" jint videoOnJNILoad(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_AnimatedFileDrawableStream = (jclass) env->NewGlobalRef(env->FindClass("tglive/fqrs/app/AnimatedFileDrawableStream"));
