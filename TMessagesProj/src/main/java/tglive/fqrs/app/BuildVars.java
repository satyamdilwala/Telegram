...
public class BuildVars {
    ...
    public static String BUILD_VERSION_STRING = tglive.fqrs.app.BuildConfig.BUILD_VERSION_STRING;

    public static int APP_ID = 29614720;
    public static String APP_HASH = "9bd4f5fb282140d0a399f312c0a22435";

    // SafetyNet key for Google Identity SDK, set it to empty to disable
    public static String SAFETYNET_KEY = "AIzaSyDqt8P-7F7CPCseMkOiVRgb1LY8RN1bvH8";
    public static String PLAYSTORE_APP_URL = "https://play.google.com/store/apps/details?id=tglive.fqrs.app";
