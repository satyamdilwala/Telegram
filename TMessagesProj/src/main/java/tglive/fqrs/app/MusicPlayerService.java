...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "tglive.fqrs.app.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "tglive.fqrs.app.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "tglive.fqrs.app.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "tglive.fqrs.app.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "tglive.fqrs.app.android.musicplayer.next";
    public static final String NOTIFY_SEEK = "tglive.fqrs.app.android.musicplayer.seek";
