...
import static tglive.fqrs.app.LocaleController.formatPluralSpannable;
...
import tglive.fqrs.app.ringtone.RingtoneDataStore;
...
import tglive.fqrs.app.ui.Components.EllipsizeSpanAnimator;
...
import tglive.fqrs.app.ui.Components.TranscribeButton;
...
import tglive.fqrs.app.ui.PeerColorActivity;
            ...
            for (int i = 0; i < messageOwner.restriction_reason.size(); ++i) {
                ...
                if (
                    ...
                    (
                        ...
                        "android".equals(reason.platform) && (!ApplicationLoader.isStandaloneBuild() && true || BuildVars.DEBUG_PRIVATE_VERSION) ||
