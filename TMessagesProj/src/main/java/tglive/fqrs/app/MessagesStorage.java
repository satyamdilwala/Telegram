...
import static tglive.fqrs.app.MessagesController.LOAD_AROUND_DATE;
import static tglive.fqrs.app.MessagesController.LOAD_AROUND_MESSAGE;
import static tglive.fqrs.app.MessagesController.LOAD_BACKWARD;
import static tglive.fqrs.app.MessagesController.LOAD_FORWARD;
import static tglive.fqrs.app.MessagesController.LOAD_FROM_UNREAD;
...
import tglive.fqrs.app.ui.EditWidgetActivity;
    ...
    try {
      ...
      if (updateTopic) {
        if (unreadMentionsCount >= 0) {
          if (BuildVars.DEBUG_VERSION && unreadMentionsCount > 0) {
...
//            cursor = null;
        ...
        while (iterator.hasNext()) {
          ...
          if (BuildVars.DEBUG_VERSION && newUnreadMentions > 0) {
...
//        }
        ...
        if (!topicsMessagesToUpdate.isEmpty()) {
          ...
          for (TopicKey topicKey : topicsMessagesToUpdate.keySet()) {
            ...
            if (BuildVars.DEBUG_VERSION && newUnreadMentionsCount > 0) {
