...
import static tglive.fqrs.app.ui.Components.Premium.LimitReachedBottomSheet.TYPE_ACCOUNTS;
import static tglive.fqrs.app.ui.Components.Premium.LimitReachedBottomSheet.TYPE_BOOSTS_FOR_USERS;
...
import tglive.fqrs.app.AutoDeleteMediaTask;
import tglive.fqrs.app.BackupAgent;
...
import tglive.fqrs.app.ChannelBoostsController;
import tglive.fqrs.app.ChatObject;
import tglive.fqrs.app.ContactsController;
import tglive.fqrs.app.ContactsLoadingObserver;
import tglive.fqrs.app.DialogObject;
import tglive.fqrs.app.FileLoader;
import tglive.fqrs.app.FileLog;
import tglive.fqrs.app.FingerprintController;
import tglive.fqrs.app.FlagSecureReason;
import tglive.fqrs.app.GenericProvider;
import tglive.fqrs.app.LiteMode;
import tglive.fqrs.app.LocaleController;
import tglive.fqrs.app.LocationController;
import tglive.fqrs.app.MediaController;
...
import tglive.fqrs.app.OpenAttachedMenuBotReceiver;
import tglive.fqrs.app.PushListenerController;
import tglive.fqrs.app.R;
import tglive.fqrs.app.SendMessagesHelper;
import tglive.fqrs.app.SharedConfig;
import tglive.fqrs.app.SharedPrefsHelper;
import tglive.fqrs.app.TopicsController;
import tglive.fqrs.app.UserConfig;
import tglive.fqrs.app.UserNameResolver;
import tglive.fqrs.app.UserObject;
import tglive.fqrs.app.Utilities;
import tglive.fqrs.app.browser.Browser;
import tglive.fqrs.app.pip.PipActivityController;
import tglive.fqrs.app.pip.activity.IPipActivity;
import tglive.fqrs.app.pip.activity.IPipActivityHandler;
import tglive.fqrs.app.pip.activity.IPipActivityListener;
import tglive.fqrs.app.voip.VideoCapturerDevice;
import tglive.fqrs.app.voip.VoIPGroupNotification;
import tglive.fqrs.app.voip.VoIPPendingCall;
import tglive.fqrs.app.voip.VoIPPreNotificationService;
import tglive.fqrs.app.voip.VoIPService;
import tglive.fqrs.app.tgnet.ConnectionsManager;
import tglive.fqrs.app.tgnet.TLObject;
import tglive.fqrs.app.tgnet.TLRPC;
import tglive.fqrs.app.tgnet.Vector;
import tglive.fqrs.app.tgnet.tl.TL_account;
import tglive.fqrs.app.tgnet.tl.TL_chatlists;
import tglive.fqrs.app.tgnet.tl.TL_forum;
import tglive.fqrs.app.tgnet.tl.TL_stars;
import tglive.fqrs.app.tgnet.tl.TL_stories;
import tglive.fqrs.app.ui.ActionBar.ActionBarLayout;
import tglive.fqrs.app.ui.ActionBar.AlertDialog;
import tglive.fqrs.app.ui.ActionBar.BaseFragment;
import tglive.fqrs.app.ui.ActionBar.BottomSheetTabs;
import tglive.fqrs.app.ui.ActionBar.BottomSheetTabsOverlay;
import tglive.fqrs.app.ui.ActionBar.CustomNavigationBar;
...
import tglive.fqrs.app.ui.Adapters.DrawerLayoutAdapter;
...
import tglive.fqrs.app.ui.Cells.LanguageCell;
import tglive.fqrs.app.ui.Components.AlertsCreator;
import tglive.fqrs.app.ui.Components.AnimatedEmojiDrawable;
import tglive.fqrs.app.ui.Components.AppIconBulletinLayout;
import tglive.fqrs.app.ui.Components.AttachBotIntroTopView;
import tglive.fqrs.app.ui.Components.AudioPlayerAlert;
import tglive.fqrs.app.ui.Components.BatteryDrawable;
import tglive.fqrs.app.ui.Components.BlockingUpdateView;
...
import tglive.fqrs.app.ui.Components.Easings;
import tglive.fqrs.app.ui.Components.EmbedBottomSheet;
import tglive.fqrs.app.ui.Components.EmojiPacksAlert;
import tglive.fqrs.app.ui.Components.FireworksOverlay;
...
import tglive.fqrs.app.ui.Components.GroupCallPip;
...
import tglive.fqrs.app.ui.Components.PasscodeView;
import tglive.fqrs.app.ui.Components.PasscodeViewDialog;
import tglive.fqrs.app.ui.Components.PhonebookShareAlert;
import tglive.fqrs.app.ui.Components.PipRoundVideoView;
import tglive.fqrs.app.ui.Components.PipVideoOverlay;
import tglive.fqrs.app.ui.Components.Premium.LimitReachedBottomSheet;
import tglive.fqrs.app.ui.Components.Premium.boosts.BoostPagerBottomSheet;
import tglive.fqrs.app.ui.Components.Premium.boosts.GiftInfoBottomSheet;
...
import tglive.fqrs.app.ui.Components.SearchTagsList;
import tglive.fqrs.app.ui.Components.SharingLocationsAlert;
import tglive.fqrs.app.ui.Components.SideMenultItemAnimator;
import tglive.fqrs.app.ui.Components.SizeNotifierFrameLayout;
import tglive.fqrs.app.ui.Components.StickerSetBulletinLayout;
import tglive.fqrs.app.ui.Components.StickersAlert;
import tglive.fqrs.app.ui.Components.TermsOfServiceView;
import tglive.fqrs.app.ui.Components.ThemeEditorView;
import tglive.fqrs.app.ui.Components.UndoView;
import tglive.fqrs.app.ui.Components.spoilers.SpoilerEffect2;
import tglive.fqrs.app.ui.Components.voip.RTMPStreamPipOverlay;
import tglive.fqrs.app.ui.Components.voip.VoIPHelper;
import tglive.fqrs.app.ui.Gifts.GiftSheet;
import tglive.fqrs.app.ui.Gifts.SendGiftSheet;
import tglive.fqrs.app.ui.Stars.ISuperRipple;
...
import tglive.fqrs.app.ui.Stars.SuperRipple;
import tglive.fqrs.app.ui.Stars.SuperRippleFallback;
import tglive.fqrs.app.ui.Stories.StoriesController;
import tglive.fqrs.app.ui.Stories.StoriesListPlaceProvider;
import tglive.fqrs.app.ui.Stories.StoryViewer;
import tglive.fqrs.app.ui.Stories.recorder.StoryEntry;
import tglive.fqrs.app.ui.Stories.recorder.StoryRecorder;
import tglive.fqrs.app.ui.TON.TONIntroActivity;
import tglive.fqrs.app.ui.bots.BotWebViewAttachedSheet;
import tglive.fqrs.app.ui.bots.BotWebViewSheet;
import tglive.fqrs.app.ui.bots.WebViewRequestProps;
...
public class LaunchActivity extends BasePermissionsActivity implements INavigationLayout.INavigationLayoutDelegate, NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate, IPipActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setTheme(tglive.fqrs.app.R.style.Theme_TMessages);
    try {
    ...
    getWindow().setBackgroundDrawableResource(tglive.fqrs.app.R.drawable.transparent);
    ...
    sideMenu.setOnItemClickListener((view, position, x, y) -> {
      ...
      if (position == 0) {
        ...
        if (id == 2) {
          ...
          Browser.openUrl(LaunchActivity.this, LocaleController.getString(tglive.fqrs.app.R.string.TelegramFaqUrl));
          drawerLayoutContainer.closeDrawer(false);
        } else if (id == 10) {
          ...
          Browser.openUrl(LaunchActivity.this, LocaleController.getString(tglive.fqrs.app.R.string.TelegramFeaturesUrl));
          drawerLayoutContainer.closeDrawer(false);
        } else if (id == 15) {
...
//    }
  ...
  private void setupActionBarLayout() {
    ...
    if (AndroidUtilities.isTablet()) {
      ...
      layersView.setBackgroundResource(tglive.fqrs.app.R.drawable.popup_fixed_alert3);
          ...
          for (int i = 0; i < sideMenu.getChildCount(); ++i) {
            ...
            if (child instanceof DrawerUserCell) {
              ...
              ((DrawerActionCell) child).updateTextAndIcon(
                getString(hasStatus ? tglive.fqrs.app.R.string.ChangeEmojiStatus : tglive.fqrs.app.R.string.SetEmojiStatus),
                hasStatus ?
                  tglive.fqrs.app.R.drawable.msg_status_edit :
                  tglive.fqrs.app.R.drawable.msg_status_set
              );
            }
          }
        }
...
//      dismissAllWeb();
    ...
    if ((flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
      if (intent != null && intent.getAction() != null && !restore) {
        ...
        } else if ("tglive.fqrs.app.CREATE_STICKER_PACK".equals(intent.getAction())) {
          try {
...
//                        storyId = Utilities.parseInt(data.getQueryParameter("story"));
                ...
                try (Cursor cursor = getContentResolver().query(intent.getData(), null, null, null, null)) {
                  if (cursor != null) {
                    if (cursor.moveToFirst()) {
                      ...
                      if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.tglive.fqrs.app.android.call")) {
                        audioCallUser = true;
                      } else if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.tglive.fqrs.app.android.call.video")) {
                        videoCallUser = true;
                      }
                    }
                  }
        ...
        } else if (intent.getAction().equals("tglive.fqrs.app.OPEN_ACCOUNT")) {
          open_settings = 1;
...
//              push_story_id = intent.getIntExtra("storyId", 0);
    ...
    if (UserConfig.getInstance(currentAccount).isClientActivated()) {
      ...
      if (push_story_id > 0) {
        ...
        boolean can = BuildVars.DEBUG_VERSION; // TODO: check source
        if (!can) {
        ...
        if (bulletinText != null) {
          BaseFragment fragment = actionBarLayout.getLastFragment();
          if (fragment != null) {
// //             BulletinFactory.of(fragment).createSimpleBulletin(tglive.fqrs.app.R.raw.info, bulletinText).show();
          }
        }
        ...
        fragment.setQrLoginDelegate(code -> {
          ...
          ConnectionsManager.getInstance(currentAccount).sendRequest(req, (response, error) -> AndroidUtilities.runOnUIThread(() -> {
            ...
            if (!(response instanceof TLRPC.TL_authorization)) {
              AndroidUtilities.runOnUIThread(() -> AlertsCreator.showSimpleAlert(fragment, LocaleController.getString(tglive.fqrs.app.R.string.AuthAnotherClient), LocaleController.getString(tglive.fqrs.app.R.string.ErrorOccurred) + "\n" + error.text));
            }
          }));
        });
        getActionBarLayout().presentFragment(new INavigationLayout.NavigationParams(fragment).setNoAnimation(true));
        ...
        if (lastFragment != null && lastFragment.getParentActivity() != null) {
          ...
          final AlertDialog newContactAlertDialog = new AlertDialog.Builder(lastFragment.getParentActivity())
              .setTitle(LocaleController.getString(tglive.fqrs.app.R.string.NewContactAlertTitle))
              .setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("NewContactAlertMessage", tglive.fqrs.app.R.string.NewContactAlertMessage, PhoneFormat.getInstance().format(finalNewContactPhone))))
              .setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.NewContactAlertButton), (d, i) -> {
  ...
  private void openDialogsToSend(boolean animated) {
    ...
    if (contactsToSend != null) {
      if (contactsToSend.size() != 1) {
        args.putString("selectAlertString", LocaleController.getString(tglive.fqrs.app.R.string.SendMessagesToText));
        args.putString("selectAlertStringGroup", LocaleController.getString(tglive.fqrs.app.R.string.SendContactToGroupText));
      }
    } else {
      args.putString("selectAlertString", LocaleController.getString(tglive.fqrs.app.R.string.SendMessagesToText));
      args.putString("selectAlertStringGroup", LocaleController.getString(tglive.fqrs.app.R.string.SendMessagesToGroupText));
    }
      ...
      if (!chatOpened) {
        try {
          if (!mainFragmentsStack.isEmpty()) {
            BulletinFactory.of(mainFragmentsStack.get(mainFragmentsStack.size() - 1)).createErrorBulletin(LocaleController.getString(tglive.fqrs.app.R.string.ChannelPostDeleted)).show();
          }
        } catch (Exception e) {
          FileLog.e(e);
        }
      ...
      AndroidUtilities.runOnUIThread(() -> {
        ...
        if (!(AndroidUtilities.isTablet() ? rightActionBarLayout : getActionBarLayout()).presentFragment(chatActivity) && dialogId < 0) {
          ...
          final int reqId = ConnectionsManager.getInstance(currentAccount).sendRequest(req, (response, error) -> AndroidUtilities.runOnUIThread(() -> {
            ...
            if (notFound) {
              showAlertDialog(AlertsCreator.createNoAccessAlert(LaunchActivity.this, LocaleController.getString(tglive.fqrs.app.R.string.DialogNotAvailable), LocaleController.getString(tglive.fqrs.app.R.string.LinkNotFound), null));
            }
          }));
          if (progress != null) {
            progress.onCancel(() -> {
  ...
  private void runLinkRequest(
    ...
    if (state == 0 && ChatActivity.SCROLL_DEBUG_DELAY && progress != null) {
      ...
      if (NotificationCenter.getGlobalInstance().hasObservers(NotificationCenter.didReceiveSmsCode)) {
        ...
        builder.setTitle(LocaleController.getString(tglive.fqrs.app.R.string.AppName));
        builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString(tglive.fqrs.app.R.string.OtherLoginCode, code)));
        builder.setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.OK), null);
        showAlertDialog(builder);
      }
      return;
    } else if (loginToken != null) {
      AlertDialog.Builder builder = new AlertDialog.Builder(LaunchActivity.this);
      builder.setTitle(LocaleController.getString(tglive.fqrs.app.R.string.AuthAnotherClient));
      builder.setMessage(LocaleController.getString(tglive.fqrs.app.R.string.AuthAnotherClientUrl));
      builder.setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.OK), null);
      showAlertDialog(builder);
      return;
    }
    ...
    if (contactToken != null) {
      ...
      requestId[0] = ConnectionsManager.getInstance(intentAccount).sendRequest(req, (response, error) -> AndroidUtilities.runOnUIThread(() -> {
        if (response instanceof TLRPC.User) {
          ...
          BulletinFactory.of(mainFragmentsStack.get(mainFragmentsStack.size() - 1)).createErrorBulletin(LocaleController.getString(tglive.fqrs.app.R.string.NoUsernameFound)).show();
        }
      ...
      requestId[0] = ConnectionsManager.getInstance(intentAccount).sendRequest(req, (response, error) -> AndroidUtilities.runOnUIThread(() -> {
        ...
        if (response instanceof TL_chatlists.chatlist_ChatlistInvite) {
          ...
          if (!(inv instanceof TL_chatlists.TL_chatlists_chatlistInvite && ((TL_chatlists.TL_chatlists_chatlistInvite) inv).peers.isEmpty())) {
            ...
            BulletinFactory.of(fragment).createErrorBulletin(LocaleController.getString(tglive.fqrs.app.R.string.NoFolderFound)).show();
          }
        } else {
          BulletinFactory.of(fragment).createErrorBulletin(LocaleController.getString(tglive.fqrs.app.R.string.NoFolderFound)).show();
        }
      ...
      requestId[0] = ConnectionsManager.getInstance(intentAccount).sendRequest(req, (response, error) -> AndroidUtilities.runOnUIThread(() -> {
        if (error != null) {
          BulletinFactory.of(mainFragmentsStack.get(mainFragmentsStack.size() - 1))
            .createSimpleBulletin(tglive.fqrs.app.R.raw.error, getString(tglive.fqrs.app.R.string.UniqueGiftNotFound))
            .show();
      ...
      requestId[0] = ConnectionsManager.getInstance(intentAccount).sendRequest(req, (response, error) -> AndroidUtilities.runOnUIThread(() -> {
        if (error != null) {
          if ("SUBSCRIPTION_ALREADY_ACTIVE".equalsIgnoreCase(error.text)) {
            BulletinFactory.of(mainFragmentsStack.get(mainFragmentsStack.size() - 1)).createErrorBulletin(LocaleController.getString(tglive.fqrs.app.R.string.PaymentInvoiceSubscriptionLinkAlreadyPaid)).show();
          } else {
            BulletinFactory.of(mainFragmentsStack.get(mainFragmentsStack.size() - 1)).createErrorBulletin(LocaleController.getString(tglive.fqrs.app.R.string.PaymentInvoiceLinkInvalid)).show();
          }
      ...
      MessagesController.getInstance(intentAccount).getUserNameResolver().resolve(username, referrer, (peerId) -> {
        if (peerId != null && peerId == Long.MAX_VALUE) {
          ...
          new AlertDialog.Builder(this, null)
            .setTitle(LocaleController.getString(tglive.fqrs.app.R.string.AffiliateLinkExpiredTitle))
            .setMessage(LocaleController.getString(tglive.fqrs.app.R.string.AffiliateLinkExpiredText))
            .setNegativeButton(LocaleController.getString(tglive.fqrs.app.R.string.OK), null)
            .show();
          return;
        }
        if (!LaunchActivity.this.isFinishing()) {
          ...
          if (storyId != 0 && peerId != null) {
            ...
            MessagesController.getInstance(currentAccount).getStoriesController().resolveStoryLink(peerId, storyId, storyItem -> {
              ...
              if (storyItem == null) {
                ...
                if (factory != null) {
                  factory.createSimpleBulletin(tglive.fqrs.app.R.raw.story_bomb2, LocaleController.getString(tglive.fqrs.app.R.string.StoryNotFound)).show();
                }
                return;
              } else if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                BulletinFactory factory = BulletinFactory.global();
                if (factory != null) {
                  factory.createSimpleBulletin(tglive.fqrs.app.R.raw.story_bomb1, LocaleController.getString(tglive.fqrs.app.R.string.StoryNotFound)).show();
                }
                return;
              }
            ...
            MessagesController.getInstance(currentAccount).getStoriesController().resolveStoryAlbumLink(peerId, storyAlbumId, storyAlbum -> {
              ...
              if (storyAlbum == null) {
                BulletinFactory factory = BulletinFactory.global();
                if (factory != null) {
                  factory.createSimpleBulletin(tglive.fqrs.app.R.raw.story_bomb2, LocaleController.getString(tglive.fqrs.app.R.string.StoryAlbumNotFound)).show();
                }
                return;
              }
            ...
            if (botAppStartParam != null) {
              ...
              if (user != null && user.bot) {
                if (user.bot_attach_menu) {
                  ...
                  BulletinFactory.of(mainFragmentsStack.get(mainFragmentsStack.size() - 1)).createErrorBulletin(LocaleController.getString(tglive.fqrs.app.R.string.BotCantAddToAttachMenu)).show();
                }
              } else {
                BulletinFactory.of(mainFragmentsStack.get(mainFragmentsStack.size() - 1)).createErrorBulletin(LocaleController.getString(tglive.fqrs.app.R.string.BotSetAttachLinkNotBot)).show();
              }
              ...
              args.putString("selectAlertString", LocaleController.getString(tglive.fqrs.app.R.string.SendGameToText));
              args.putString("selectAlertStringGroup", LocaleController.getString(tglive.fqrs.app.R.string.SendGameToGroupText));
              DialogsActivity fragment = new DialogsActivity(args);
              TLRPC.User user = MessagesController.getInstance(intentAccount).getUser(peerId);
              ...
              if (user == null || user.bot && user.bot_nochats) {
                try {
                  if (!mainFragmentsStack.isEmpty()) {
                    BulletinFactory.of(mainFragmentsStack.get(mainFragmentsStack.size() - 1)).createErrorBulletin(LocaleController.getString(tglive.fqrs.app.R.string.BotCantJoinGroups)).show();
                  }
                } catch (Exception e) {
                  FileLog.e(e);
                }
...
//              args.putString("addToGroupAlertString", LocaleController.formatString("AddToTheGroupAlertText", tglive.fqrs.app.R.string.AddToTheGroupAlertText, UserObject.getUserName(user), "%1$s"));
              DialogsActivity fragment = new DialogsActivity(args);
              fragment.setDelegate((fragment12, dids, message1, param, notify, scheduleDate, topicsFragment) -> {
                ...
                if (chat != null && (chat.creator || chat.admin_rights != null && chat.admin_rights.add_admins)) {
                  ...
                  builder.setTitle(LocaleController.getString(tglive.fqrs.app.R.string.AddBot));
                  String chatName = chat == null ? "" : chat.title;
                  builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("AddMembersAlertNamesText", tglive.fqrs.app.R.string.AddMembersAlertNamesText, UserObject.getUserName(user), chatName)));
                  builder.setNegativeButton(LocaleController.getString(tglive.fqrs.app.R.string.Cancel), null);
                  builder.setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.AddBot), (di, i) -> {
                  ...
                  if (openProfile || giftCollectionId > 0) {
                    ...
                    MessagesController.getInstance(intentAccount).ensureMessagesLoaded(dialog_id, messageId == null ? 0 : messageId, new MessagesController.MessagesLoadedCallback() {
                                ...
                                if (chatFull != null) {
                                  if (chatFull.call == null) {
                                    if (voipLastFragment.getParentActivity() != null) {
                                      BulletinFactory.of(voipLastFragment).createSimpleBulletin(tglive.fqrs.app.R.raw.linkbroken, LocaleController.getString(tglive.fqrs.app.R.string.InviteExpired)).show();
                                    }
                                  } else {
                      ...
                      public void onError() {
                        if (!LaunchActivity.this.isFinishing()) {
                          BaseFragment fragment = mainFragmentsStack.get(mainFragmentsStack.size() - 1);
                          AlertsCreator.showSimpleAlert(fragment, LocaleController.getString(tglive.fqrs.app.R.string.JoinToGroupErrorNotExist));
                        }
                        try {
                          dismissLoading.run();
                        } catch (Exception e) {
            ...
            try {
              ...
              if (lastFragment != null) {
                ...
                if (AndroidUtilities.isNumeric(username)) {
                  BulletinFactory.of(lastFragment).createErrorBulletin(LocaleController.getString(tglive.fqrs.app.R.string.NoPhoneFound)).show();
                } else {
                  BulletinFactory.of(lastFragment).createErrorBulletin(LocaleController.getString(tglive.fqrs.app.R.string.NoUsernameFound)).show();
                }
              }
            } catch (Exception e) {
              FileLog.e(e);
          ...
          if (!LaunchActivity.this.isFinishing()) {
            ...
            if (error == null && actionBarLayout != null) {
                ...
                StarsController.getInstance(currentAccount).subscribeTo(group, invite, (status, dialogId) -> {
                  if ("paid".equals(status) && dialogId != 0) {
                    AndroidUtilities.runOnUIThread(() -> {
                      ...
                      if (chat != null) {
                        AndroidUtilities.runOnUIThread(() -> {
                          BulletinFactory.of(chatActivity).createSimpleBulletin(tglive.fqrs.app.R.raw.stars_send, LocaleController.getString(tglive.fqrs.app.R.string.StarsSubscriptionCompleted), AndroidUtilities.replaceTags(formatPluralString("StarsSubscriptionCompletedText", (int) stars, chat.title))).show(true);
                        }, 250);
                      }
                    });
                  }
              ...
              if (error.text.startsWith("FLOOD_WAIT")) {
                builder.setMessage(LocaleController.getString(tglive.fqrs.app.R.string.FloodWait));
              } else if (error.text.startsWith("INVITE_HASH_EXPIRED")) {
                builder.setTitle(LocaleController.getString(tglive.fqrs.app.R.string.ExpiredLink));
                builder.setMessage(LocaleController.getString(tglive.fqrs.app.R.string.InviteExpired));
              } else {
                builder.setMessage(LocaleController.getString(tglive.fqrs.app.R.string.JoinToGroupErrorNotExist));
              }
              builder.setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.OK), null);
              showAlertDialog(builder);
            }
            ...
            if (!LaunchActivity.this.isFinishing()) {
              ...
              if (error == null) {
                ...
                if (error.text.startsWith("FLOOD_WAIT")) {
                  ...
                  builder.setMessage(LocaleController.getString(tglive.fqrs.app.R.string.JoinToGroupErrorFull));
                } else {
                  builder.setMessage(LocaleController.getString(tglive.fqrs.app.R.string.JoinToGroupErrorNotExist));
                }
                builder.setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.OK), null);
          ...
          AndroidUtilities.runOnUIThread(() -> {
            try {
              ...
              if ("APP_VERSION_OUTDATED".equals(error.text)) {
                AlertsCreator.showUpdateAppAlert(LaunchActivity.this, LocaleController.getString(tglive.fqrs.app.R.string.UpdateAppAlert), true);
              } else {
                showAlertDialog(AlertsCreator.createSimpleAlert(LaunchActivity.this, LocaleController.getString(tglive.fqrs.app.R.string.ErrorOccurred) + "\n" + error.text));
              }
            } catch (Exception e) {
              FileLog.e(e);
            }
      ...
      requestId[0] = ConnectionsManager.getInstance(currentAccount).sendRequest(req, (response, error) -> AndroidUtilities.runOnUIThread(() -> {
        ...
        if (response instanceof TLRPC.TL_langPackLanguage) {
          ...
          if ("LANG_CODE_NOT_SUPPORTED".equals(error.text)) {
            showAlertDialog(AlertsCreator.createSimpleAlert(LaunchActivity.this, LocaleController.getString(tglive.fqrs.app.R.string.LanguageUnsupportedError)));
          } else {
            showAlertDialog(AlertsCreator.createSimpleAlert(LaunchActivity.this, LocaleController.getString(tglive.fqrs.app.R.string.ErrorOccurred) + "\n" + error.text));
          }
        }
      ...
      requestId[0] = ConnectionsManager.getInstance(currentAccount).sendRequest(req, (response, error) -> AndroidUtilities.runOnUIThread(() -> {
        ...
        if (notFound != 0) {
          ...
          if (notFound == 1) {
            showAlertDialog(AlertsCreator.createSimpleAlert(LaunchActivity.this, LocaleController.getString(tglive.fqrs.app.R.string.Theme), LocaleController.getString(tglive.fqrs.app.R.string.ThemeNotSupported)));
          } else {
            showAlertDialog(AlertsCreator.createSimpleAlert(LaunchActivity.this, LocaleController.getString(tglive.fqrs.app.R.string.Theme), LocaleController.getString(tglive.fqrs.app.R.string.ThemeNotFound)));
          }
        }
      }));
      ...
      ConnectionsManager.getInstance(currentAccount).sendRequest(req, (res, err) -> AndroidUtilities.runOnUIThread(() -> {
        if (res instanceof TL_account.resolvedBusinessChatLinks) {
          ...
          showAlertDialog(AlertsCreator.createSimpleAlert(LaunchActivity.this, LocaleController.getString(tglive.fqrs.app.R.string.BusinessLink), LocaleController.getString(tglive.fqrs.app.R.string.BusinessLinkInvalid)));
        }
      }));
    }
...
//            }
        ...
        if (!attachMenuBot.inactive) {
          if (dialogsActivity != null) {
            ...
            if (!MediaDataController.canShowAttachMenuBot(attachMenuBot, chatActivity.getCurrentUser() != null ? chatActivity.getCurrentUser() : chatActivity.getCurrentChat())) {
              BulletinFactory.of(lastFragment).createErrorBulletin(LocaleController.getString(tglive.fqrs.app.R.string.BotAlreadyAddedToAttachMenu)).show();
              return;
            }
          ...
          if (contact != null) {
            ...
            if (user != null) {
              ...
              if (UserObject.isReplyUser(user)) {
                names[2] = LocaleController.getString(tglive.fqrs.app.R.string.RepliesTitle).toLowerCase();
              } else if (user.self) {
                names[2] = LocaleController.getString(tglive.fqrs.app.R.string.SavedMessages).toLowerCase();
              }
  ...
  public void checkAppUpdate(boolean force, Browser.Progress progress) {
    ...
    if (ApplicationLoader.applicationLoaderInstance.isCustomUpdate()) {
      final Object prevUpdate = ApplicationLoader.applicationLoaderInstance.getUpdate();
      ...
      ApplicationLoader.applicationLoaderInstance.checkUpdate(force, () -> {
        final Object pendingUpdate = ApplicationLoader.applicationLoaderInstance.getUpdate();
        if (progress != null) {
          progress.end();
          if (pendingUpdate == null) {
            BaseFragment fragment = getLastFragment();
            if (fragment != null) {
              BulletinFactory.of(fragment).createSimpleBulletin(tglive.fqrs.app.R.raw.chats_infotip, LocaleController.getString(tglive.fqrs.app.R.string.YourVersionIsLatest)).show();
            }
          }
        }
        if (pendingUpdate != null && !ApplicationLoader.applicationLoaderInstance.isDownloadingUpdate() && (first || prevUpdate == null)) {
      ...
      if (response instanceof TLRPC.TL_help_appUpdate) {
        ...
        AndroidUtilities.runOnUIThread(() -> {
          ...
          if (newVersionAvailable) {
            ...
            } else if (false || BuildVars.DEBUG_VERSION) {
              drawerLayoutAdapter.notifyDataSetChanged();
            ...
            try {
              ...
              if (fragment != null) {
                BulletinFactory.of(fragment).createSimpleBulletin(
                  tglive.fqrs.app.R.raw.msg_translate,
                  getStringForLanguageAlert(shorname.equals("en") ? englishLocaleStrings : systemLocaleStrings, "ChangeLanguageLater", tglive.fqrs.app.R.string.ChangeLanguageLater)
  ...
  private void onPowerSaver(boolean applied) {
    ...
    BulletinFactory.of(lastFragment).createSimpleBulletin(
      ...
      LocaleController.getString(tglive.fqrs.app.R.string.LowPowerEnabledTitle),
      LocaleController.formatString("LowPowerEnabledSubtitle", tglive.fqrs.app.R.string.LowPowerEnabledSubtitle, String.format("%d%%", percent)),
      LocaleController.getString(tglive.fqrs.app.R.string.Disable),
  ...
  public void didReceivedNotification(int id, final int account, Object... args) {
    if (id == NotificationCenter.appDidLogout) {
      ...
      if (fragment != null) {
        ...
        builder.setTopAnimation(tglive.fqrs.app.R.raw.not_available, AlertsCreator.NEW_DENY_DIALOG_TOP_ICON_SIZE, false, fragment.getThemedColor(Theme.key_dialogTopBackground), colorsReplacement);
        builder.setTopAnimationIsNew(true);
      }
      if (reason != 2 && reason != 3) {
        builder.setNegativeButton(LocaleController.getString(tglive.fqrs.app.R.string.MoreInfo), (dialogInterface, i) -> {
          if (!mainFragmentsStack.isEmpty()) {
      ...
      if (reason == 5) {
        builder.setMessage(LocaleController.getString(tglive.fqrs.app.R.string.NobodyLikesSpam3));
        builder.setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.OK), null);
      } else if (reason == 0) {
        builder.setMessage(LocaleController.getString(tglive.fqrs.app.R.string.NobodyLikesSpam1));
        builder.setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.OK), null);
      } else if (reason == 1) {
        builder.setMessage(LocaleController.getString(tglive.fqrs.app.R.string.NobodyLikesSpam2));
        builder.setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.OK), null);
      } else if (reason == 2) {
        ...
        if (type.startsWith("AUTH_KEY_DROP_")) {
          builder.setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.Cancel), null);
          builder.setNegativeButton(LocaleController.getString(tglive.fqrs.app.R.string.LogOut), (dialog, which) -> MessagesController.getInstance(currentAccount).performLogout(2));
        } else if (type.startsWith("PREMIUM_")) {
          builder.setTitle(LocaleController.getString(tglive.fqrs.app.R.string.TelegramPremium));
          builder.setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.OK), null);
        } else {
          builder.setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.OK), null);
        }
      } else if (reason == 3) {
        builder.setTitle(LocaleController.getString(tglive.fqrs.app.R.string.Proxy));
        builder.setMessage(LocaleController.getString(tglive.fqrs.app.R.string.UseProxyTelegramError));
        builder.setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.OK), null);
      ...
      builder.setTitle(LocaleController.getString(tglive.fqrs.app.R.string.AppName));
      builder.setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.OK), null);
      builder.setNegativeButton(LocaleController.getString(tglive.fqrs.app.R.string.ShareYouLocationUnableManually), (dialogInterface, i) -> {
        if (mainFragmentsStack.isEmpty()) {
          return;
        }
      ...
      builder.setMessage(LocaleController.getString(tglive.fqrs.app.R.string.ShareYouLocationUnable));
      if (!mainFragmentsStack.isEmpty()) {
        mainFragmentsStack.get(mainFragmentsStack.size() - 1).showDialog(builder.create());
      }
      ...
      AlertDialog.Builder builder = new AlertDialog.Builder(LaunchActivity.this);
      builder.setTopAnimation(tglive.fqrs.app.R.raw.permission_request_contacts, AlertsCreator.PERMISSIONS_REQUEST_TOP_ICON_SIZE, false, Theme.getColor(Theme.key_dialogTopBackground));
      builder.setTitle(LocaleController.getString(tglive.fqrs.app.R.string.UpdateContactsTitle));
      builder.setMessage(LocaleController.getString(tglive.fqrs.app.R.string.UpdateContactsMessage));
      builder.setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.OK), (dialogInterface, i) -> ContactsController.getInstance(account).syncPhoneBookByAlert(contactHashMap, first, schedule, false));
      builder.setNegativeButton(LocaleController.getString(tglive.fqrs.app.R.string.Cancel), (dialog, which) -> ContactsController.getInstance(account).syncPhoneBookByAlert(contactHashMap, first, schedule, true));
      ...
      if (!mainFragmentsStack.isEmpty()) {
        ...
        switch (type) {
          case Bulletin.TYPE_NAME_CHANGED: {
            ...
            String text = peerId > 0 ? LocaleController.getString(tglive.fqrs.app.R.string.YourNameChanged) : LocaleController.getString(tglive.fqrs.app.R.string.ChannelTitleChanged);
          ...
          case Bulletin.TYPE_BIO_CHANGED: {
            long peerId = (long) args[1];
            String text = peerId > 0 ? LocaleController.getString(tglive.fqrs.app.R.string.YourBioChanged) : LocaleController.getString(tglive.fqrs.app.R.string.ChannelDescriptionChanged);
            (container != null ? BulletinFactory.of(container, null) : BulletinFactory.of(fragment)).createErrorBulletin(text).show();
            break;
          }
  ...
  private void showLanguageAlertInternal(LocaleController.LocaleInfo systemInfo, LocaleController.LocaleInfo englishInfo, String systemLang) {
    try {
      ...
      AlertDialog.Builder builder = new AlertDialog.Builder(LaunchActivity.this);
      builder.setTitle(getStringForLanguageAlert(systemLocaleStrings, "ChooseYourLanguage", tglive.fqrs.app.R.string.ChooseYourLanguage));
      builder.setSubtitle(getStringForLanguageAlert(englishLocaleStrings, "ChooseYourLanguage", tglive.fqrs.app.R.string.ChooseYourLanguage));
      ...
      final String englishName = getStringForLanguageAlert(systemLocaleStrings, "English", tglive.fqrs.app.R.string.English);
      ...
      cell.setValue(getStringForLanguageAlert(systemLocaleStrings, "ChooseYourLanguageOther", tglive.fqrs.app.R.string.ChooseYourLanguageOther), getStringForLanguageAlert(englishLocaleStrings, "ChooseYourLanguageOther", tglive.fqrs.app.R.string.ChooseYourLanguageOther));
      ...
      builder.setNegativeButton(LocaleController.getString(tglive.fqrs.app.R.string.OK), (dialog, which) -> {
  ...
  private void updateCurrentConnectionState(int account) {
    ...
    if (currentConnectionState == ConnectionsManager.ConnectionStateWaitingForNetwork) {
      ...
      titleId = tglive.fqrs.app.R.string.WaitingForNetwork;
    } else if (currentConnectionState == ConnectionsManager.ConnectionStateUpdating) {
      title = "Updating";
      titleId = tglive.fqrs.app.R.string.Updating;
    } else if (currentConnectionState == ConnectionsManager.ConnectionStateConnectingToProxy) {
      title = "ConnectingToProxy";
      titleId = tglive.fqrs.app.R.string.ConnectingToProxy;
    } else if (currentConnectionState == ConnectionsManager.ConnectionStateConnecting) {
      title = "Connecting";
      titleId = tglive.fqrs.app.R.string.Connecting;
    }
  ...
  private void openMyStory(final int storyId, boolean openViews) {
    ...
    ConnectionsManager.getInstance(currentAccount).sendRequest(req, (res, err) -> AndroidUtilities.runOnUIThread(() -> {
      ...
      BulletinFactory.global().createSimpleBulletin(tglive.fqrs.app.R.raw.error, LocaleController.getString(tglive.fqrs.app.R.string.StoryNotFound)).show(false);
    }));
  }
