...
public class BlurringShader {
    ...
    public void draw(float[] oesMatrix, int texture, int textureWidth, int textureHeight) {
        ...
        tglive.fqrs.app.ui.Components.Paint.Shader.SetColorUniform(p.gradientTopHandle, gradientTop);
        tglive.fqrs.app.ui.Components.Paint.Shader.SetColorUniform(p.gradientBottomHandle, gradientBottom);
