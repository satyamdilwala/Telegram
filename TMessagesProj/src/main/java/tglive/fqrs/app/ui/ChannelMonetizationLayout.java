...
import static tglive.fqrs.app.AndroidUtilities.REPLACING_TAG_TYPE_LINK_NBSP;
import static tglive.fqrs.app.AndroidUtilities.dp;
import static tglive.fqrs.app.AndroidUtilities.makeBlurBitmap;
...
import static tglive.fqrs.app.tgnet.ConnectionsManager.DEFAULT_DATACENTER_ID;
  ...
  public void setupBalances(boolean ton, TLRPC.TL_starsRevenueStatus balances) {
    if (ton) {
      ...
      if (starsBalanceButton != null) {
        starsBalanceButton.setVisibility(balances.available_balance.amount > 0 || BuildVars.DEBUG_VERSION ? View.VISIBLE : View.GONE);
      }
    }
