...
import tglive.fqrs.app.MessagePreviewParams;
...
//        sendMessagesView.setOnClickListener(View -> didSendPressed());
      ...
      if (textSelectionOverlay != null) {
        ...
        addView(textSelectionOverlay, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.MATCH_PARENT, Gravity.TOP | Gravity.LEFT, 0, tglive.fqrs.app.ui.ActionBar.ActionBar.getCurrentActionBarHeight() / AndroidUtilities.density, 0, 0));
      }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
      ...
      ((MarginLayoutParams) chatListView.getLayoutParams()).topMargin = tglive.fqrs.app.ui.ActionBar.ActionBar.getCurrentActionBarHeight();
      if (isLandscapeMode) {
