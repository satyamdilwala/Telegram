...
import tglive.fqrs.app.FileRefController;
...
import tglive.fqrs.app.ui.Stories.recorder.DraftsController;
...
import tglive.fqrs.app.ui.Stories.recorder.StoryUploadingService;
...
//    peerStories.stories.addAll(stories.stories);
  ...
  public class UploadingStory implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void sendUploadedRequest(TLRPC.InputFile uploadedFile) {
      ...
      if (BuildVars.DEBUG_VERSION && !edit && entry.caption != null && entry.caption.toString().contains("#failtest") && !hadFailed) {
