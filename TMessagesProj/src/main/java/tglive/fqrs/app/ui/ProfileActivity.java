...
import static tglive.fqrs.app.AndroidUtilities.formatSpannable;
import static tglive.fqrs.app.AndroidUtilities.dpf2;
import static tglive.fqrs.app.AndroidUtilities.ilerp;
import static tglive.fqrs.app.AndroidUtilities.lerp;
import static tglive.fqrs.app.ContactsController.PRIVACY_RULES_TYPE_ADDED_BY_PHONE;
...
import static tglive.fqrs.app.ui.Stars.StarGiftSheet.replaceUnderstood;
import static tglive.fqrs.app.ui.Stars.StarsIntroActivity.formatStarsAmountShort;
import static tglive.fqrs.app.ui.bots.AffiliateProgramFragment.percents;
...
import tglive.fqrs.app.AuthTokensHelper;
...
import tglive.fqrs.app.ChatThemeController;
...
import tglive.fqrs.app.LanguageDetector;
...
import tglive.fqrs.app.tgnet.tl.TL_bots;
...
import tglive.fqrs.app.ui.ActionBar.OKLCH;
...
import tglive.fqrs.app.ui.Business.OpeningHoursActivity;
import tglive.fqrs.app.ui.Business.ProfileHoursCell;
import tglive.fqrs.app.ui.Business.ProfileLocationCell;
import tglive.fqrs.app.ui.Cells.AboutLinkCell;
import tglive.fqrs.app.ui.Cells.CheckBoxCell;
...
import tglive.fqrs.app.ui.Cells.NotificationsCheckCell;
import tglive.fqrs.app.ui.Cells.ProfileChannelCell;
import tglive.fqrs.app.ui.Cells.SettingsSearchCell;
import tglive.fqrs.app.ui.Cells.SettingsSuggestionCell;
import tglive.fqrs.app.ui.Cells.ShadowSectionCell;
import tglive.fqrs.app.ui.Cells.TextCell;
import tglive.fqrs.app.ui.Cells.TextCheckCell;
import tglive.fqrs.app.ui.Cells.TextDetailCell;
...
import tglive.fqrs.app.ui.Components.AnimatedColor;
import tglive.fqrs.app.ui.Components.AnimatedEmojiDrawable;
import tglive.fqrs.app.ui.Components.AnimatedEmojiSpan;
import tglive.fqrs.app.ui.Components.AnimatedFileDrawable;
...
import tglive.fqrs.app.ui.Components.AutoDeletePopupWrapper;
...
import tglive.fqrs.app.ui.Components.ButtonBounce;
import tglive.fqrs.app.ui.Components.CanvasButton;
import tglive.fqrs.app.ui.Components.ChatActivityInterface;
import tglive.fqrs.app.ui.Components.ChatAvatarContainer;
import tglive.fqrs.app.ui.Components.ChatNotificationsPopupWrapper;
import tglive.fqrs.app.ui.Components.ColoredImageSpan;
import tglive.fqrs.app.ui.Components.CombinedDrawable;
import tglive.fqrs.app.ui.Components.CrossfadeDrawable;
import tglive.fqrs.app.ui.Components.CubicBezierInterpolator;
import tglive.fqrs.app.ui.Components.DotDividerSpan;
import tglive.fqrs.app.ui.Components.EmojiPacksAlert;
import tglive.fqrs.app.ui.Components.EmptyStubSpan;
...
import tglive.fqrs.app.ui.Components.HintView;
import tglive.fqrs.app.ui.Components.IdenticonDrawable;
import tglive.fqrs.app.ui.Components.ImageUpdater;
import tglive.fqrs.app.ui.Components.InstantCameraView;
...
import tglive.fqrs.app.ui.Components.MessagePrivateSeenView;
import tglive.fqrs.app.ui.Components.ProfileActionsView;
import tglive.fqrs.app.ui.Components.ProfileGalleryBlurView;
import tglive.fqrs.app.ui.Components.Paint.PersistColorPalette;
import tglive.fqrs.app.ui.Components.Premium.LimitPreviewView;
...
import tglive.fqrs.app.ui.Components.Premium.PremiumPreviewBottomSheet;
import tglive.fqrs.app.ui.Components.Premium.ProfilePremiumCell;
import tglive.fqrs.app.ui.Components.Premium.boosts.UserSelectorBottomSheet;
import tglive.fqrs.app.ui.Components.ProfileGalleryView;
import tglive.fqrs.app.ui.Components.ProfileGooeyView;
import tglive.fqrs.app.ui.Components.ProfileMusicView;
...
import tglive.fqrs.app.ui.Components.ScamDrawable;
import tglive.fqrs.app.ui.Components.ShareAlert;
import tglive.fqrs.app.ui.Components.SharedMediaLayout;
import tglive.fqrs.app.ui.Components.SizeNotifierFrameLayout;
import tglive.fqrs.app.ui.Components.StarRatingView;
import tglive.fqrs.app.ui.Components.StickerEmptyView;
import tglive.fqrs.app.ui.Components.TimerDrawable;
import tglive.fqrs.app.ui.Components.TranslateAlert2;
import tglive.fqrs.app.ui.Components.TypefaceSpan;
import tglive.fqrs.app.ui.Components.UndoView;
import tglive.fqrs.app.ui.Components.VectorAvatarThumbDrawable;
import tglive.fqrs.app.ui.Components.voip.VoIPHelper;
import tglive.fqrs.app.ui.Gifts.GiftSheet;
import tglive.fqrs.app.ui.Stars.BotStarsActivity;
import tglive.fqrs.app.ui.Stars.BotStarsController;
import tglive.fqrs.app.ui.Stars.ProfileGiftsView;
import tglive.fqrs.app.ui.Stars.StarGiftPatterns;
...
import tglive.fqrs.app.ui.Stories.ProfileStoriesView;
...
import tglive.fqrs.app.ui.Stories.recorder.DualCameraView;
...
import tglive.fqrs.app.ui.bots.AffiliateProgramFragment;
import tglive.fqrs.app.ui.bots.BotBiometry;
import tglive.fqrs.app.ui.bots.BotDownloads;
import tglive.fqrs.app.ui.bots.BotLocation;
import tglive.fqrs.app.ui.bots.BotWebViewAttachedSheet;
import tglive.fqrs.app.ui.bots.ChannelAffiliateProgramsFragment;
import tglive.fqrs.app.ui.bots.SetupEmojiStatusSheet;
    ...
    listView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() {
      ...
      public boolean onItemClick(View view, int position) {
        if (position == versionRow) {
          pressCount++;
          if (pressCount >= 2 || BuildVars.DEBUG_VERSION) {
            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity(), resourcesProvider);
            ...
            items = new CharSequence[]{
                ...
                null,
                BuildVars.DEBUG_VERSION || false ? getString("DebugMenuCheckAppUpdate", R.string.DebugMenuCheckAppUpdate) : null,
                getString("DebugMenuReadAllDialogs", R.string.DebugMenuReadAllDialogs),
                BuildVars.DEBUG_VERSION ? (SharedConfig.disableVoiceAudioEffects ? "Enable voip audio effects" : "Disable voip audio effects") : null,
                BuildVars.DEBUG_VERSION ? "Clean app update" : null,
                BuildVars.DEBUG_VERSION ? "Reset suggestions" : null,
                BuildVars.DEBUG_VERSION ? getString(R.string.DebugMenuClearWebViewCache) : null,
                ...
                (AndroidUtilities.isTabletInternal() && BuildVars.DEBUG_VERSION) ? (SharedConfig.forceDisableTabletMode ? "Enable tablet mode" : "Disable tablet mode") : null,
                BuildVars.DEBUG_VERSION ? getString(SharedConfig.isFloatingDebugActive ? R.string.FloatingDebugDisable : R.string.FloatingDebugEnable) : null,
                BuildVars.DEBUG_VERSION ? "Force remove premium suggestions" : null,
                BuildVars.DEBUG_VERSION ? "Share device info" : null,
                BuildVars.DEBUG_VERSION ? "Force performance class" : null,
                BuildVars.DEBUG_VERSION && !InstantCameraView.allowBigSizeCameraDebug() ? (!SharedConfig.bigCameraForRound ? "Force big camera for round" : "Disable big camera for round") : null,
                ...
                BuildVars.DEBUG_VERSION ? (SharedConfig.photoViewerBlur ? "do not blur in photoviewer" : "blur in photoviewer") : null,
                !SharedConfig.payByInvoice ? "Enable Invoice Payment" : "Disable Invoice Payment",
                BuildVars.DEBUG_VERSION ? "Update Attach Bots" : null,
                ...
                BuildVars.DEBUG_VERSION ? "Clear all login tokens" : null,
...
//        stickersRow = rowCount++;
        ...
        if (false || false || (StarsController.getInstance(currentAccount, true).balanceAvailable() && (StarsController.getInstance(currentAccount, true).hasTransactions() || StarsController.getInstance(currentAccount, true).getBalance().positive()))) {
          tonRow = rowCount++;
        }
        if (!getMessagesController().premiumFeaturesBlocked()) {
...
//          }
  ...
  private boolean editRow(View view, int position) {
    ...
    if (position == bizHoursRow) {
      ...
      itemOptions.add(R.drawable.msg_edit, getString(R.string.ProfileLocationEdit), () -> {
        presentFragment(new tglive.fqrs.app.ui.Business.LocationActivity());
      });
  ...
  private void showStarRatingBottomSheet(View ignoreView) {
    ...
    if (BuildVars.DEBUG_VERSION && userFull.stars_my_pending_rating == null) {
