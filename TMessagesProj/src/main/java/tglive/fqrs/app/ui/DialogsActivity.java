...
import static tglive.fqrs.app.LocaleController.formatPluralStringComma;
import static tglive.fqrs.app.LocaleController.formatString;
import static tglive.fqrs.app.LocaleController.getString;
import static tglive.fqrs.app.ui.Components.AlertsCreator.createClearOrDeleteDialogsAlert;
...
import tglive.fqrs.app.AnimationNotificationsLocker;
import tglive.fqrs.app.ApplicationLoader;
import tglive.fqrs.app.BirthdayController;
import tglive.fqrs.app.BotWebViewVibrationEffect;
import tglive.fqrs.app.BuildVars;
import tglive.fqrs.app.ChatObject;
import tglive.fqrs.app.ContactsController;
import tglive.fqrs.app.DialogObject;
import tglive.fqrs.app.Emoji;
import tglive.fqrs.app.FileLoader;
import tglive.fqrs.app.FileLog;
import tglive.fqrs.app.FilesMigrationService;
import tglive.fqrs.app.ImageLoader;
import tglive.fqrs.app.ImageLocation;
import tglive.fqrs.app.LiteMode;
...
import tglive.fqrs.app.MessagesStorage;
import tglive.fqrs.app.NotificationCenter;
import tglive.fqrs.app.NotificationsController;
...
import tglive.fqrs.app.XiaomiUtilities;
import tglive.fqrs.app.browser.Browser;
import tglive.fqrs.app.tgnet.ConnectionsManager;
import tglive.fqrs.app.tgnet.SerializedData;
import tglive.fqrs.app.tgnet.TLObject;
import tglive.fqrs.app.tgnet.TLRPC;
import tglive.fqrs.app.tgnet.tl.TL_account;
import tglive.fqrs.app.tgnet.tl.TL_chatlists;
import tglive.fqrs.app.tgnet.tl.TL_stars;
import tglive.fqrs.app.tgnet.tl.TL_stories;
import tglive.fqrs.app.ui.ActionBar.ActionBar;
import tglive.fqrs.app.ui.ActionBar.ActionBarMenu;
import tglive.fqrs.app.ui.ActionBar.ActionBarMenuItem;
import tglive.fqrs.app.ui.ActionBar.ActionBarMenuSubItem;
import tglive.fqrs.app.ui.ActionBar.ActionBarPopupWindow;
...
import tglive.fqrs.app.ui.ActionBar.MenuDrawable;
import tglive.fqrs.app.ui.ActionBar.SimpleTextView;
import tglive.fqrs.app.ui.ActionBar.Theme;
import tglive.fqrs.app.ui.ActionBar.ThemeDescription;
import tglive.fqrs.app.ui.Adapters.DialogsAdapter;
import tglive.fqrs.app.ui.Adapters.DialogsSearchAdapter;
import tglive.fqrs.app.ui.Adapters.FiltersView;
import tglive.fqrs.app.ui.Cells.AccountSelectCell;
import tglive.fqrs.app.ui.Cells.ArchiveHintInnerCell;
import tglive.fqrs.app.ui.Cells.BaseCell;
import tglive.fqrs.app.ui.Cells.DialogCell;
import tglive.fqrs.app.ui.Cells.DialogsEmptyCell;
import tglive.fqrs.app.ui.Cells.DialogsHintCell;
import tglive.fqrs.app.ui.Cells.DividerCell;
import tglive.fqrs.app.ui.Cells.DrawerActionCell;
import tglive.fqrs.app.ui.Cells.DrawerAddCell;
import tglive.fqrs.app.ui.Cells.DrawerProfileCell;
import tglive.fqrs.app.ui.Cells.DrawerUserCell;
import tglive.fqrs.app.ui.Cells.GraySectionCell;
import tglive.fqrs.app.ui.Cells.HashtagSearchCell;
import tglive.fqrs.app.ui.Cells.HeaderCell;
import tglive.fqrs.app.ui.Cells.HintDialogCell;
import tglive.fqrs.app.ui.Cells.LoadingCell;
import tglive.fqrs.app.ui.Cells.ProfileSearchCell;
import tglive.fqrs.app.ui.Cells.RequestPeerRequirementsCell;
import tglive.fqrs.app.ui.Cells.ShadowSectionCell;
import tglive.fqrs.app.ui.Cells.TextCell;
import tglive.fqrs.app.ui.Cells.TextInfoPrivacyCell;
import tglive.fqrs.app.ui.Cells.UnconfirmedAuthHintCell;
import tglive.fqrs.app.ui.Cells.UserCell;
import tglive.fqrs.app.ui.Components.AlertsCreator;
import tglive.fqrs.app.ui.Components.AnimatedEmojiDrawable;
import tglive.fqrs.app.ui.Components.AnimationProperties;
import tglive.fqrs.app.ui.Components.ArchiveHelp;
import tglive.fqrs.app.ui.Components.AvatarDrawable;
import tglive.fqrs.app.ui.Components.BackupImageView;
import tglive.fqrs.app.ui.Components.BlurredRecyclerView;
import tglive.fqrs.app.ui.Components.ImageUpdater;
import tglive.fqrs.app.ui.Components.PermissionRequest;
import tglive.fqrs.app.ui.Components.UItem;
import tglive.fqrs.app.ui.Gifts.GiftSheet;
import tglive.fqrs.app.ui.Stars.StarGiftSheet;
import tglive.fqrs.app.ui.Stars.StarsController;
import tglive.fqrs.app.ui.Stars.StarsIntroActivity;
import tglive.fqrs.app.ui.Stories.StealthModeAlert;
import tglive.fqrs.app.ui.bots.BotWebViewSheet;
import tglive.fqrs.app.ui.Components.Bulletin;
import tglive.fqrs.app.ui.Components.BulletinFactory;
import tglive.fqrs.app.ui.Components.ChatActivityEnterView;
import tglive.fqrs.app.ui.Components.ChatAvatarContainer;
import tglive.fqrs.app.ui.Components.CombinedDrawable;
import tglive.fqrs.app.ui.Components.CubicBezierInterpolator;
import tglive.fqrs.app.ui.Components.DialogsItemAnimator;
import tglive.fqrs.app.ui.Components.EditTextBoldCursor;
import tglive.fqrs.app.ui.Components.FilterTabsView;
import tglive.fqrs.app.ui.Components.FiltersListBottomSheet;
import tglive.fqrs.app.ui.Components.FlickerLoadingView;
import tglive.fqrs.app.ui.Components.FloatingDebug.FloatingDebugController;
import tglive.fqrs.app.ui.Components.FloatingDebug.FloatingDebugProvider;
import tglive.fqrs.app.ui.Components.FolderBottomSheet;
import tglive.fqrs.app.ui.Components.FolderDrawable;
import tglive.fqrs.app.ui.Components.ForegroundColorSpanThemable;
import tglive.fqrs.app.ui.Components.Forum.ForumUtilities;
import tglive.fqrs.app.ui.Components.FragmentContextView;
import tglive.fqrs.app.ui.Components.ItemOptions;
import tglive.fqrs.app.ui.Components.JoinGroupAlert;
import tglive.fqrs.app.ui.Components.LayoutHelper;
import tglive.fqrs.app.ui.Components.MediaActivity;
import tglive.fqrs.app.ui.Components.NumberTextView;
import tglive.fqrs.app.ui.Components.PacmanAnimation;
import tglive.fqrs.app.ui.Components.Premium.LimitReachedBottomSheet;
import tglive.fqrs.app.ui.Components.Premium.PremiumFeatureBottomSheet;
import tglive.fqrs.app.ui.Components.Premium.boosts.UserSelectorBottomSheet;
import tglive.fqrs.app.ui.Components.ProxyDrawable;
import tglive.fqrs.app.ui.Components.PullForegroundDrawable;
import tglive.fqrs.app.ui.Components.RLottieDrawable;
import tglive.fqrs.app.ui.Components.RLottieImageView;
import tglive.fqrs.app.ui.Components.RadialProgressView;
import tglive.fqrs.app.ui.Components.Reactions.ReactionsLayoutInBubble;
import tglive.fqrs.app.ui.Components.RecyclerAnimationScrollHelper;
import tglive.fqrs.app.ui.Components.RecyclerItemsEnterAnimator;
import tglive.fqrs.app.ui.Components.RecyclerListView;
import tglive.fqrs.app.ui.Components.SearchViewPager;
import tglive.fqrs.app.ui.Components.SharedMediaLayout;
import tglive.fqrs.app.ui.Components.SimpleThemeDescription;
import tglive.fqrs.app.ui.Components.SizeNotifierFrameLayout;
import tglive.fqrs.app.ui.Components.StickersAlert;
import tglive.fqrs.app.ui.Components.SwipeGestureSettingsView;
import tglive.fqrs.app.ui.Components.UndoView;
import tglive.fqrs.app.ui.Components.ViewPagerFixed;
import tglive.fqrs.app.ui.Stories.DialogStoriesCell;
import tglive.fqrs.app.ui.Stories.StoriesController;
import tglive.fqrs.app.ui.Stories.StoriesListPlaceProvider;
import tglive.fqrs.app.ui.Stories.UserListPoller;
import tglive.fqrs.app.ui.Stories.recorder.HintView2;
import tglive.fqrs.app.ui.Stories.recorder.StoryRecorder;
                        ...
                        if (diff < height || pullingTime < PullForegroundDrawable.minPullingTime) {
                            ...
                            if (parentPage.archivePullViewState != ARCHIVE_ITEM_STATE_SHOWED) {
                                ...
                                if (AndroidUtilities.isAccessibilityScreenReaderEnabled()) {
                                    AndroidUtilities.makeAccessibilityAnnouncement(LocaleController.getString(tglive.fqrs.app.R.string.AccDescrArchivedChatsShown));
                                }
                            }
                        }
...
//            }
    ...
    public void updateStatus(TLRPC.User user, boolean animated) {
        ...
        if (emojiStatusId != null) {
            ...
            if (premiumStar == null) {
                premiumStar = getContext().getResources().getDrawable(tglive.fqrs.app.R.drawable.msg_premium_liststar).mutate();
    ...
    public View createView(final Context context) {
        ...
        if (!onlySelect && searchString == null && folderId == 0) {
            ...
            doneItem.setText(LocaleController.getString(tglive.fqrs.app.R.string.Done).toUpperCase());
            ...
            proxyItem.setContentDescription(getString(tglive.fqrs.app.R.string.ProxySettings));

            passcodeDrawable = new RLottieDrawable(tglive.fqrs.app.R.raw.passcode_lock, "passcode_lock", dp(28), dp(28), true, null);
            passcodeItem = menu.addItem(1, passcodeDrawable);
            passcodeItem.setContentDescription(getString(tglive.fqrs.app.R.string.AccDescrPasscodeLock));
            ...
            downloadsItem.setContentDescription(getString(tglive.fqrs.app.R.string.DownloadsTabs));
            downloadsItem.setVisibility(View.GONE);

            updatePasscodeButton();
            updateProxyButton(false, false);
        }
        searchItem = menu.addItem(0, tglive.fqrs.app.R.drawable.ic_ab_search).setIsSearchField(true, false).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() {
            ...
            public void onPreToggleSearch() {
                if (!isSpeedItemCreated) {
                    ...
                    speedItem.setIcon(tglive.fqrs.app.R.drawable.avd_speed);
            ...
            public void onSearchExpand() {
                ...
                updatePasscodeButton();
                updateProxyButton(false, false);
                actionBar.setBackButtonContentDescription(getString(tglive.fqrs.app.R.string.AccDescrGoBack));
            ...
            public void onSearchCollapse() {
                ...
                if (menuDrawable != null) {
                    ...
                    actionBar.setBackButtonContentDescription(getString(tglive.fqrs.app.R.string.AccDescrOpenMenu));
                }
        ...
        if (isArchive()) {
            optionsItem = menu.addItem(4, tglive.fqrs.app.R.drawable.ic_ab_other);
            optionsItem.addSubItem(5, tglive.fqrs.app.R.drawable.msg_customize, getString(tglive.fqrs.app.R.string.ArchiveSettings)).setColors(getThemedColor(Theme.key_actionBarDefaultSubmenuItem), getThemedColor(Theme.key_actionBarDefaultSubmenuItem));
            optionsItem.addSubItem(6, tglive.fqrs.app.R.drawable.msg_help, getString(tglive.fqrs.app.R.string.HowDoesItWork)).setColors(getThemedColor(Theme.key_actionBarDefaultSubmenuItem), getThemedColor(Theme.key_actionBarDefaultSubmenuItem));
            optionsItem.setOnClickListener(v -> {
                getContactsController().loadGlobalPrivacySetting();
                optionsItem.toggleSubMenu();
            });
        }
        searchItem.setSearchFieldHint(getString(tglive.fqrs.app.R.string.Search));
        searchItem.setContentDescription(getString(tglive.fqrs.app.R.string.Search));
        if (onlySelect) {
            actionBar.setBackButtonImage(tglive.fqrs.app.R.drawable.ic_ab_back);
            if (initialDialogsType == DIALOGS_TYPE_BOT_SELECT_VERIFY) {
                actionBar.setTitle(getString(tglive.fqrs.app.R.string.BotChooseChatToVerify));
            } else if (isReplyTo) {
                actionBar.setTitle(LocaleController.getString(tglive.fqrs.app.R.string.ReplyToDialog));
            } else if (isQuote) {
                actionBar.setTitle(getString(tglive.fqrs.app.R.string.QuoteTo));
            } else if (initialDialogsType == DIALOGS_TYPE_FORWARD && selectAlertString == null) {
                actionBar.setTitle(getString(tglive.fqrs.app.R.string.ForwardTo));
            } else if (initialDialogsType == DIALOGS_TYPE_WIDGET) {
                actionBar.setTitle(getString(tglive.fqrs.app.R.string.SelectChats));
            } else if (initialDialogsType == DIALOGS_TYPE_START_ATTACH_BOT) {
                if (allowBots && !allowUsers && !allowGroups && !allowChannels) {
                    actionBar.setTitle(getString(tglive.fqrs.app.R.string.ChooseBot));
                } else if (allowUsers && !allowBots && !allowGroups && !allowChannels) {
                    actionBar.setTitle(getString(tglive.fqrs.app.R.string.ChooseUser));
                } else if (allowGroups && !allowUsers && !allowBots && !allowChannels) {
                    actionBar.setTitle(getString(tglive.fqrs.app.R.string.ChooseGroup));
                } else if (allowChannels && !allowUsers && !allowBots && !allowGroups) {
                    actionBar.setTitle(getString(tglive.fqrs.app.R.string.ChooseChannel));
                } else {
                    actionBar.setTitle(getString(tglive.fqrs.app.R.string.SelectChat));
                }
            ...
            if (folderId != 0) {
                actionBar.setTitle(getString(tglive.fqrs.app.R.string.ArchivedChats));
            } else {
                statusDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(null, dp(26));
                statusDrawable.center = true;
                if (BuildVars.DEBUG_VERSION) {
                    actionBar.setTitle(getString(tglive.fqrs.app.R.string.AppName), statusDrawable);
                } else {
                    actionBar.setTitle(getString(tglive.fqrs.app.R.string.AppName), statusDrawable);
                }
            ...
            filterTabsView = new FilterTabsView(context, resourceProvider) {
                ...
                protected void onDefaultTabMoved() {
                    if (!getMessagesController().premiumFeaturesBlocked()) {
                        ...
                        topBulletin = BulletinFactory.of(DialogsActivity.this).createSimpleBulletin(tglive.fqrs.app.R.raw.filter_reorder, AndroidUtilities.replaceTags(LocaleController.formatString(tglive.fqrs.app.R.string.LimitReachedReorderFolder, LocaleController.getString(tglive.fqrs.app.R.string.FilterAllChats))), LocaleController.getString(tglive.fqrs.app.R.string.PremiumMore), Bulletin.DURATION_PROLONG, () -> {
            ...
            filterTabsView.setDelegate(new FilterTabsView.FilterTabsViewDelegate() {
                ...
                private void showDeleteAlert(MessagesController.DialogFilter dialogFilter) {
                    if (dialogFilter.isChatlist()) {
                        ...
                        builder.setTitle(LocaleController.getString(tglive.fqrs.app.R.string.FilterDelete));
                        builder.setMessage(LocaleController.getString(tglive.fqrs.app.R.string.FilterDeleteAlert));
                        builder.setNegativeButton(LocaleController.getString(tglive.fqrs.app.R.string.Cancel), null);
                        builder.setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.Delete), (dialog2, which2) -> {
                ...
                public boolean didSelectTab(FilterTabsView.TabView tabView, boolean selected) {
                    ...
                    filterOptions = ItemOptions.makeOptions(DialogsActivity.this, tabView)
                            ...
                            .addIf(getMessagesController().getDialogFilters().size() > 1, tglive.fqrs.app.R.drawable.tabs_reorder, LocaleController.getString(tglive.fqrs.app.R.string.FilterReorder), () -> {
                                resetScroll();
                                filterTabsView.setIsEditing(true);
                                showDoneItem(true);
                            })
                            .add(tglive.fqrs.app.R.drawable.msg_edit, defaultTab ? LocaleController.getString(tglive.fqrs.app.R.string.FilterEditAll) : LocaleController.getString(tglive.fqrs.app.R.string.FilterEdit), () -> {
                                presentFragment(defaultTab ? new FiltersSetupActivity() : new FilterCreateActivity(dialogFilter));
                            })
                            .addIf(dialogFilter != null && !dialogs.isEmpty(), muteAll ? tglive.fqrs.app.R.drawable.msg_mute : tglive.fqrs.app.R.drawable.msg_unmute, muteAll ? LocaleController.getString(tglive.fqrs.app.R.string.FilterMuteAll) : LocaleController.getString(tglive.fqrs.app.R.string.FilterUnmuteAll), () -> {
                                int count = 0;
                                for (int i = 0; i < dialogs.size(); ++i) {
                                    TLRPC.Dialog dialog = dialogs.get(i);
                                    if (dialog != null) {
                            ...
                            .addIf(hasUnread, tglive.fqrs.app.R.drawable.msg_markread, LocaleController.getString(tglive.fqrs.app.R.string.MarkAllAsRead), () -> {
                                markDialogsAsRead(dialogs);
                            })
                            .addIf(hasShare, tglive.fqrs.app.R.drawable.msg_share, FilterCreateActivity.withNew(filter != null && filter.isMyChatlist() ? -1 : 0, LocaleController.getString(tglive.fqrs.app.R.string.LinkActionShare), true), () -> {
                                if (shareEmpty[0]) {
                            ...
                            .addIf(!defaultTab, tglive.fqrs.app.R.drawable.msg_delete, LocaleController.getString(tglive.fqrs.app.R.string.FilterDeleteItem), true, () -> {
...
//        createActionMode(null);
            ...
            public void onItemClick(int id) {
                ...
                if (id == -1) {
                    ...
                    if (currentCount + neverShow.size() > 100) {
                        showDialog(AlertsCreator.createSimpleAlert(getParentActivity(), LocaleController.getString(tglive.fqrs.app.R.string.FilterAddToAlertFullTitle), LocaleController.getString(tglive.fqrs.app.R.string.FilterAddToAlertFullText)).create());
                        return;
                    }
        ...
        for (int a = 0; a < pagesCount; a++) {
                    ...
                    if (viewPage.dialogsType == DIALOGS_TYPE_DEFAULT && viewPage.archivePullViewState != ARCHIVE_ITEM_STATE_PINNED && hasHiddenArchive() && !fixScrollYAfterArchiveOpened) {
                        ...
                        if (currentPosition == 0 && firstView != null && (firstView.getBottom() - pTop) >= dp(4)) {
                            ...
                            if (changed && AndroidUtilities.isAccessibilityScreenReaderEnabled()) {
                                AndroidUtilities.makeAccessibilityAnnouncement(LocaleController.getString(tglive.fqrs.app.R.string.AccDescrArchivedChatsHidden));
                            }
                            if (viewPage.pullForegroundDrawable != null) {
            ...
            if (viewPage.pullForegroundDrawable == null && folderId == 0) {
                viewPage.pullForegroundDrawable = new PullForegroundDrawable(LocaleController.getString(tglive.fqrs.app.R.string.AccSwipeForArchive), LocaleController.getString(tglive.fqrs.app.R.string.AccReleaseForArchive)) {
                    @Override
        ...
        if (initialDialogsType != DIALOGS_TYPE_WIDGET) {
            ...
            floatingButton2.setImageResource(tglive.fqrs.app.R.drawable.fab_compose_small);
            floatingButton2Container.setContentDescription(LocaleController.getString(tglive.fqrs.app.R.string.NewMessageTitle));
        ...
        if (!isArchive() && initialDialogsType == DIALOGS_TYPE_DEFAULT) {
            if (MessagesController.getInstance(currentAccount).getMainSettings().getBoolean("storyhint", true)) {
                storyHint = new HintView2(context, HintView2.DIRECTION_RIGHT)
                        ...
                        .setText(AndroidUtilities.replaceCharSequence("%s", LocaleController.getString(tglive.fqrs.app.R.string.StoryCameraHint), StoryRecorder.cameraBtnSpan(context)))
                        .setJoint(1, -40)
        ...
        if (Build.VERSION.SDK_INT < 21) {
            Drawable shadowDrawable = context.getResources().getDrawable(tglive.fqrs.app.R.drawable.floating_shadow).mutate();
        ...
        if (!onlySelect && initialDialogsType == 0) {
            ...
            writeButton = new ChatActivityEnterView.SendButton(context, tglive.fqrs.app.R.drawable.attach_send, resourceProvider) {
                @Override
        ...
        dialogStoriesCell = new DialogStoriesCell(context, this, currentAccount, isArchive() ? DialogStoriesCell.TYPE_ARCHIVE : DialogStoriesCell.TYPE_DIALOGS) {
            ...
            public void onUserLongPressed(View view, long dialogId) {
                ...
                if (dialogId == UserConfig.getInstance(currentAccount).getClientUserId()) {
                    ...
                    filterOptions.add(tglive.fqrs.app.R.drawable.msg_stories_add, LocaleController.getString(tglive.fqrs.app.R.string.AddStory), Theme.key_actionBarDefaultSubmenuItemIcon, Theme.key_actionBarDefaultSubmenuItem, () -> {
                        dialogStoriesCell.openStoryRecorder();
                    });
                    filterOptions.add(tglive.fqrs.app.R.drawable.msg_stories_archive, LocaleController.getString(tglive.fqrs.app.R.string.ArchivedStories), Theme.key_actionBarDefaultSubmenuItemIcon, Theme.key_actionBarDefaultSubmenuItem, () -> {
                        Bundle args = new Bundle();
                    ...
                    filterOptions.add(tglive.fqrs.app.R.drawable.msg_stories_saved,  LocaleController.getString(tglive.fqrs.app.R.string.SavedStories), Theme.key_actionBarDefaultSubmenuItemIcon, Theme.key_actionBarDefaultSubmenuItem, () -> {
                        Bundle args = new Bundle();
                        args.putLong("dialog_id", UserConfig.getInstance(currentAccount).getClientUserId());
                        args.putInt("type", MediaActivity.TYPE_STORIES);
                    ...
                    if (!isPremiumBlocked && dialogId > 0 && !isPremium) {
                        Drawable lockIcon = ContextCompat.getDrawable(getContext(), tglive.fqrs.app.R.drawable.msg_gallery_locked2);
                        if (lockIcon != null) {
                            Drawable stealthDrawable = ContextCompat.getDrawable(getContext(), tglive.fqrs.app.R.drawable.msg_stealth_locked);
                    ...
                    filterOptions
                            .addIf(dialogId > 0, tglive.fqrs.app.R.drawable.msg_discussion, LocaleController.getString(tglive.fqrs.app.R.string.SendMessage), () -> {
                                presentFragment(ChatActivity.of(dialogId));
                            })
                            .addIf(dialogId > 0, tglive.fqrs.app.R.drawable.msg_openprofile, LocaleController.getString(tglive.fqrs.app.R.string.OpenProfile), () -> {
                                presentFragment(ProfileActivity.of(dialogId));
                            })
                            .addIf(dialogId < 0, tglive.fqrs.app.R.drawable.msg_channel, LocaleController.getString(ChatObject.isChannelAndNotMegaGroup(chat) ? tglive.fqrs.app.R.string.OpenChannel2 : tglive.fqrs.app.R.string.OpenGroup2), () -> {
                                presentFragment(ChatActivity.of(dialogId));
                            }).addIf(!muted && dialogId > 0, tglive.fqrs.app.R.drawable.msg_mute, LocaleController.getString(tglive.fqrs.app.R.string.NotificationsStoryMute2), () -> {
                                ...
                                BulletinFactory.of(DialogsActivity.this).createUsersBulletin(Arrays.asList(user), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryMutedHint", tglive.fqrs.app.R.string.NotificationsStoryMutedHint, name))).show();
                            }).makeMultiline(false).addIf(muted && dialogId > 0, tglive.fqrs.app.R.drawable.msg_unmute, LocaleController.getString(tglive.fqrs.app.R.string.NotificationsStoryUnmute2), () -> {
                                ...
                                BulletinFactory.of(DialogsActivity.this).createUsersBulletin(Arrays.asList(user), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryUnmutedHint", tglive.fqrs.app.R.string.NotificationsStoryUnmutedHint, name))).show();
                            }).makeMultiline(false).addIf(!isPremiumBlocked && dialogId > 0 && isPremium && isUnread, tglive.fqrs.app.R.drawable.msg_stories_stealth2, LocaleController.getString(tglive.fqrs.app.R.string.ViewAnonymously), () -> {
                            ...
                            }).makeMultiline(false).addIf(!isPremiumBlocked && dialogId > 0 && !isPremium && isUnread, tglive.fqrs.app.R.drawable.msg_stories_stealth2, stealthModeLockedDrawable, LocaleController.getString(tglive.fqrs.app.R.string.ViewAnonymously), () -> {
                                StealthModeAlert stealthModeAlert = new StealthModeAlert(getContext(), 0, StealthModeAlert.TYPE_FROM_DIALOGS, resourceProvider);
                                stealthModeAlert.setListener(isStealthModeEnabled -> {
                                    if (view instanceof StoryCell) {
                                        dialogStoriesCell.openStoryForCell((StoryCell) view);
                                ...
                                showDialog(stealthModeAlert);
                            }).makeMultiline(false).addIf(!fromTopPeer && !isArchive(), tglive.fqrs.app.R.drawable.msg_archive, LocaleController.getString(tglive.fqrs.app.R.string.ArchivePeerStories), () -> {
                                toggleArciveForStory(dialogId);
                            }).makeMultiline(false).addIf(!fromTopPeer && isArchive(), tglive.fqrs.app.R.drawable.msg_unarchive, LocaleController.getString(tglive.fqrs.app.R.string.UnarchiveStories), () -> {
                                toggleArciveForStory(dialogId);
                            }).makeMultiline(false).addIf(fromTopPeer, tglive.fqrs.app.R.drawable.msg_delete, getString(tglive.fqrs.app.R.string.StoriesRemoveFromRecent), () -> {
        ...
        if (searchString == null && initialDialogsType == DIALOGS_TYPE_DEFAULT) {
            ...
            if (updateButton != null) {
                contentView.addView((View) updateButton, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, 48, Gravity.LEFT | Gravity.BOTTOM));
    ...
    private void toggleArciveForStory(long dialogId) {
        ...
        AndroidUtilities.runOnUIThread(() -> {
            ...
            if (isArchive()) {
                str = AndroidUtilities.replaceTags(LocaleController.formatString("StoriesMovedToDialogs", tglive.fqrs.app.R.string.StoriesMovedToDialogs, name));
            } else {
                str = AndroidUtilities.replaceTags(LocaleController.formatString("StoriesMovedToContacts", tglive.fqrs.app.R.string.StoriesMovedToContacts, ContactsController.formatName(name, null, 15)));
            }
...
//    }
    ...
    private void showPremiumBlockedToast(View view, long dialogId) {
        ...
        Bulletin bulletin;
        if (getMessagesController().premiumFeaturesBlocked()) {
            bulletin = BulletinFactory.of(this).createSimpleBulletin(tglive.fqrs.app.R.raw.star_premium_2, AndroidUtilities.replaceTags(LocaleController.formatString(tglive.fqrs.app.R.string.UserBlockedNonPremium, username)));
        } else {
            bulletin = BulletinFactory.of(this)
                .createSimpleBulletin(tglive.fqrs.app.R.raw.star_premium_2, AndroidUtilities.replaceTags(LocaleController.formatString(tglive.fqrs.app.R.string.UserBlockedNonPremium, username)), LocaleController.getString(tglive.fqrs.app.R.string.UserBlockedNonPremiumButton), () -> {
    ...
    private void updateDialogsHint() {
        ...
        if (isInPreviewMode()) {
            ...
            dialogsHintCell.setText(
                getString(tglive.fqrs.app.R.string.AccountFrozenAlertTitle),
                getString(tglive.fqrs.app.R.string.AccountFrozenAlertSubtitle),
                false,
                true
            );
            updateAuthHintCellVisibility(false);
            ...
            dialogsHintCell.setText(Emoji.replaceWithRestrictedEmoji(LocaleController.getString(tglive.fqrs.app.R.string.GraceTitle), dialogsHintCell.titleView, this::updateDialogsHint), LocaleController.getString(tglive.fqrs.app.R.string.GraceMessage));
            ...
            dialogsHintCell.setText(StarsIntroActivity.replaceStarsWithPlain(formatPluralStringComma("StarsSubscriptionExpiredHintTitle2", (int) (starsNeeded - c.balance.amount <= 0 ? starsNeeded : starsNeeded - c.balance.amount), starsNeededName), .72f), LocaleController.getString(tglive.fqrs.app.R.string.StarsSubscriptionExpiredHintText));
            dialogsHintCell.setOnCloseListener(v -> {
            ...
            dialogsHintCell.setText(Emoji.replaceWithRestrictedEmoji(AndroidUtilities.replaceSingleTag(
                users.size() == 1 ?
                    LocaleController.formatString(tglive.fqrs.app.R.string.BirthdayTodaySingleTitle, UserObject.getForcedFirstName(users.get(0))) :
                ...
                LocaleController.formatString(users.size() == 1 ? tglive.fqrs.app.R.string.BirthdayTodaySingleMessage2 : tglive.fqrs.app.R.string.BirthdayTodayMultipleMessage2)
            );
            dialogsHintCell.setOnCloseListener(v -> {
                ...
                BulletinFactory.of(this)
                        .createSimpleBulletin(tglive.fqrs.app.R.raw.gift, LocaleController.getString(tglive.fqrs.app.R.string.BoostingPremiumChristmasToast), 4)
            ...
            dialogsHintCell.setCompact(true);
            dialogsHintCell.setOnClickListener(v -> {
                showDialog(AlertsCreator.createBirthdayPickerDialog(getContext(), getString(tglive.fqrs.app.R.string.EditProfileBirthdayTitle), getString(tglive.fqrs.app.R.string.EditProfileBirthdayButton), null, birthday -> {
                    ...
                    getConnectionsManager().sendRequest(req, (res, err) -> AndroidUtilities.runOnUIThread(() -> {
                        if (res instanceof TLRPC.TL_boolTrue) {
                            BulletinFactory.of(DialogsActivity.this)
                                .createSimpleBulletin(tglive.fqrs.app.R.raw.gift, getString(tglive.fqrs.app.R.string.PrivacyBirthdaySetDone), getString(tglive.fqrs.app.R.string.PrivacyBirthdaySetDoneInfo))
                                ...
                                if (getContext() != null) {
                                    showDialog(
                                        new AlertDialog.Builder(getContext(), resourceProvider)
                                            .setTitle(getString(tglive.fqrs.app.R.string.PrivacyBirthdayTooOftenTitle))
                                            .setMessage(getString(tglive.fqrs.app.R.string.PrivacyBirthdayTooOftenMessage))
                                            .setPositiveButton(getString(tglive.fqrs.app.R.string.OK), null)
                                            .create()
                                    );
                                }
                            } else {
                                BulletinFactory.of(DialogsActivity.this)
                                    .createSimpleBulletin(tglive.fqrs.app.R.raw.error, LocaleController.getString(tglive.fqrs.app.R.string.UnknownError))
                                    .show();
                            }
                        }
            ...
            dialogsHintCell.setText(Emoji.replaceWithRestrictedEmoji(LocaleController.getString(tglive.fqrs.app.R.string.BirthdaySetupTitle), dialogsHintCell.titleView, this::updateDialogsHint), LocaleController.formatString(tglive.fqrs.app.R.string.BirthdaySetupMessage));
            dialogsHintCell.setOnCloseListener(v -> {
                MessagesController.getInstance(currentAccount).removeSuggestion(0, "BIRTHDAY_SETUP");
                ChangeBounds transition = new ChangeBounds();
                transition.setDuration(200);
                ...
                BulletinFactory.of(this)
                    .createSimpleBulletin(tglive.fqrs.app.R.raw.chats_infotip, LocaleController.getString(tglive.fqrs.app.R.string.BirthdaySetupLater), LocaleController.getString(tglive.fqrs.app.R.string.Settings), () -> {
            ...
            dialogsHintCell.setText(Emoji.replaceEmoji(AndroidUtilities.replaceSingleTag(
                    LocaleController.getString(tglive.fqrs.app.R.string.GiftPremiumEventAdsTitle),
                    Theme.key_windowBackgroundWhiteValueText,
                    AndroidUtilities.REPLACING_TAG_TYPE_LINKBOLD,
                    null
            ), null, false), LocaleController.formatString("BoostingPremiumChristmasSubTitle", tglive.fqrs.app.R.string.BoostingPremiumChristmasSubTitle));
            dialogsHintCell.setOnCloseListener(v -> {
            ...
            dialogsHintCell.setText(
                    AndroidUtilities.replaceSingleTag(
                            LocaleController.formatString(tglive.fqrs.app.R.string.RestorePremiumHintTitle, MediaDataController.getInstance(currentAccount).getPremiumHintAnnualDiscount(false)),
                            Theme.key_windowBackgroundWhiteValueText,
                            AndroidUtilities.REPLACING_TAG_TYPE_LINKBOLD,
                            null
                    ),
                    LocaleController.getString(tglive.fqrs.app.R.string.RestorePremiumHintMessage)
            );
            updateAuthHintCellVisibility(false);
            ...
            dialogsHintCell.setText(
                    AndroidUtilities.replaceSingleTag(
                            LocaleController.formatString(isPremiumHintUpgrade ? tglive.fqrs.app.R.string.SaveOnAnnualPremiumTitle : tglive.fqrs.app.R.string.UpgradePremiumTitle, MediaDataController.getInstance(currentAccount).getPremiumHintAnnualDiscount(false)),
                            Theme.key_windowBackgroundWhiteValueText,
                            AndroidUtilities.REPLACING_TAG_TYPE_LINKBOLD,
                            null
                    ),
                    LocaleController.getString(isPremiumHintUpgrade ? tglive.fqrs.app.R.string.UpgradePremiumMessage : tglive.fqrs.app.R.string.SaveOnAnnualPremiumMessage)
            );
            updateAuthHintCellVisibility(false);
            ...
            dialogsHintCell.setText(
                    AndroidUtilities.replaceSingleTag(
                            LocaleController.formatString(tglive.fqrs.app.R.string.ClearStorageHintTitle, AndroidUtilities.formatFileSize(cacheSize)),
                            Theme.key_windowBackgroundWhiteValueText,
                            AndroidUtilities.REPLACING_TAG_TYPE_LINKBOLD,
                            null
                    ),
                    LocaleController.getString(tglive.fqrs.app.R.string.ClearStorageHintMessage)
            );
            updateAuthHintCellVisibility(false);
            ...
            final RLottieDrawable drawable = new RLottieDrawable(tglive.fqrs.app.R.raw.photopic, "photopic", dp(38), dp(38), true, null);
            ...
            dialogsHintCell.setText(
                Emoji.replaceWithRestrictedEmoji(LocaleController.getString(tglive.fqrs.app.R.string.HintAddYourPhoto), dialogsHintCell.titleView, this::updateDialogsHint),
                getString(tglive.fqrs.app.R.string.HintAddYourPhotoText)
            );
            dialogsHintCell.setOnCloseListener(v -> {
    ...
    private void createActionMode(String tag) {
        ...
        pinItem = actionMode.addItemWithWidth(pin, tglive.fqrs.app.R.drawable.msg_pin, dp(54));
        muteItem = actionMode.addItemWithWidth(mute, tglive.fqrs.app.R.drawable.msg_mute, dp(54));
        archive2Item = actionMode.addItemWithWidth(archive2, tglive.fqrs.app.R.drawable.msg_archive, dp(54));
        deleteItem = actionMode.addItemWithWidth(delete, tglive.fqrs.app.R.drawable.msg_delete, dp(54), LocaleController.getString(tglive.fqrs.app.R.string.Delete));
        ActionBarMenuItem otherItem = actionMode.addItemWithWidth(0, tglive.fqrs.app.R.drawable.ic_ab_other, dp(54), LocaleController.getString(tglive.fqrs.app.R.string.AccDescrMoreOptions));
        archiveItem = otherItem.addSubItem(archive, tglive.fqrs.app.R.drawable.msg_archive, LocaleController.getString(tglive.fqrs.app.R.string.Archive));
        pin2Item = otherItem.addSubItem(pin2, tglive.fqrs.app.R.drawable.msg_pin, LocaleController.getString(tglive.fqrs.app.R.string.DialogPin));
        addToFolderItem = otherItem.addSubItem(add_to_folder, tglive.fqrs.app.R.drawable.msg_addfolder, LocaleController.getString(tglive.fqrs.app.R.string.FilterAddTo));
        removeFromFolderItem = otherItem.addSubItem(remove_from_folder, tglive.fqrs.app.R.drawable.msg_removefolder, LocaleController.getString(tglive.fqrs.app.R.string.FilterRemoveFrom));
        readItem = otherItem.addSubItem(read, tglive.fqrs.app.R.drawable.msg_markread, LocaleController.getString(tglive.fqrs.app.R.string.MarkAsRead));
        clearItem = otherItem.addSubItem(clear, tglive.fqrs.app.R.drawable.msg_clear, LocaleController.getString(tglive.fqrs.app.R.string.ClearHistory));
        blockItem = otherItem.addSubItem(block, tglive.fqrs.app.R.drawable.msg_block, LocaleController.getString(tglive.fqrs.app.R.string.BlockUser));
            ...
            if (force || filterTabsView.getVisibility() != View.VISIBLE) {
                ...
                for (int a = 0, N = filters.size(); a < N; a++) {
                    if (filters.get(a).isDefault()) {
                        filterTabsView.addTab(a, 0, LocaleController.getString(tglive.fqrs.app.R.string.FilterAllChats), null, false, true, filters.get(a).locked);
                    } else {
    ...
    public void onResume() {
        ...
        if (tosAccepted && folderId == 0 && checkPermission && !onlySelect && Build.VERSION.SDK_INT >= 23) {
                    ...
                    if (hasNotNotificationsPermission || hasNotContactsPermission || hasNotStoragePermission) {
                        ...
                        if (hasNotNotificationsPermission && NotificationPermissionDialog.shouldAsk(activity)) {
                            ...
                            if (activity instanceof BasePermissionsActivity) {
                                ...
                                showDialog(permissionDialog = basePermissionsActivity.createPermissionErrorAlert(tglive.fqrs.app.R.raw.permission_request_folder, getString(tglive.fqrs.app.R.string.PermissionStorageWithHint)));
                            }
                        } else {
            ...
            showDialog(new AlertDialog.Builder(getParentActivity())
                    .setTopAnimation(tglive.fqrs.app.R.raw.permission_request_apk, AlertsCreator.PERMISSIONS_REQUEST_TOP_ICON_SIZE, false, Theme.getColor(Theme.key_dialogTopBackground))
                    .setMessage(getString(tglive.fqrs.app.R.string.PermissionXiaomiLockscreen))
                    .setPositiveButton(getString(tglive.fqrs.app.R.string.PermissionOpenSettings), (dialog, which) -> {
                    ...
                    .setNegativeButton(getString(tglive.fqrs.app.R.string.ContactsPermissionAlertNotNow), (dialog, which) -> MessagesController.getGlobalNotificationsSettings().edit().putBoolean("askedAboutMiuiLockscreen", true).commit())
                    .create());
            ...
            showDialog(new AlertDialog.Builder(getParentActivity())
                .setTopAnimation(tglive.fqrs.app.R.raw.permission_request_apk, AlertsCreator.PERMISSIONS_REQUEST_TOP_ICON_SIZE, false, Theme.getColor(Theme.key_dialogTopBackground))
                .setMessage(getString(tglive.fqrs.app.R.string.PermissionFSILockscreen))
                .setPositiveButton(getString(tglive.fqrs.app.R.string.PermissionOpenSettings), (dialog, which) -> {
                ...
                .setNegativeButton(getString(tglive.fqrs.app.R.string.ContactsPermissionAlertNotNow), (dialog, which) -> MessagesController.getGlobalNotificationsSettings().edit().putBoolean("askedAboutFSILockscreen", true).commit())
                .create());
        }
        showFiltersHint();
        if (viewPages != null) {
    ...
    private void showSearch(boolean show, boolean startFromDownloads, boolean animated, boolean forceNotOnlyDialogs) {
        ...
        if (show) {
            ...
            if (folderId != 0 && (rightSlidingDialogContainer == null || !rightSlidingDialogContainer.hasFragment())) {
                FiltersView.MediaFilterData filterData = new FiltersView.MediaFilterData(tglive.fqrs.app.R.drawable.chats_archive, tglive.fqrs.app.R.string.ArchiveSearchFilter, null, FiltersView.FILTER_TYPE_ARCHIVE);
...
//                            ForumUtilities.applyTopic(activity, MessagesStorage.TopicKey.of(-chat.id, getMessagesController().getForumLastTopicId(chat.id)));
    ...
    private boolean onItemLongClick(RecyclerListView listView, View view, int position, float x, float y, int dialogsType, RecyclerListView.Adapter adapter) {
        ...
        if (searchViewPager != null && adapter == searchViewPager.dialogsSearchAdapter) {
            ...
            if (!searchViewPager.dialogsSearchAdapter.isSearchWas()) {
                AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                builder.setTitle(LocaleController.getString(tglive.fqrs.app.R.string.ClearSearchSingleAlertTitle));
                long did;
                if (item instanceof TLRPC.Chat) {
                    TLRPC.Chat chat = (TLRPC.Chat) item;
                    if (chat.monoforum) {
                        builder.setMessage(LocaleController.formatString("ClearSearchSingleChatAlertText", tglive.fqrs.app.R.string.ClearSearchSingleChatAlertText, ForumUtilities.getMonoForumTitle(currentAccount, chat)));
                    } else {
                        builder.setMessage(LocaleController.formatString("ClearSearchSingleChatAlertText", tglive.fqrs.app.R.string.ClearSearchSingleChatAlertText, chat.title));
                    }
                    did = -chat.id;
                } else if (item instanceof TLRPC.User) {
                    TLRPC.User user = (TLRPC.User) item;
                    if (user.id == getUserConfig().clientUserId) {
                        builder.setMessage(LocaleController.formatString("ClearSearchSingleChatAlertText", tglive.fqrs.app.R.string.ClearSearchSingleChatAlertText, LocaleController.getString(tglive.fqrs.app.R.string.SavedMessages)));
                    } else {
                        builder.setMessage(LocaleController.formatString("ClearSearchSingleUserAlertText", tglive.fqrs.app.R.string.ClearSearchSingleUserAlertText, ContactsController.formatName(user.first_name, user.last_name)));
                    }
                    did = user.id;
                ...
                builder.setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.ClearSearchRemove), (dialogInterface, i) -> searchViewPager.dialogsSearchAdapter.removeRecentSearch(did));
                builder.setNegativeButton(LocaleController.getString(tglive.fqrs.app.R.string.Cancel), null);
                AlertDialog alertDialog = builder.create();
                showDialog(alertDialog);
                TextView button = (TextView) alertDialog.getButton(DialogInterface.BUTTON_POSITIVE);
    ...
    private void onArchiveLongPress(View view) {
        ...
        int[] icons = new int[]{
                hasUnread ? tglive.fqrs.app.R.drawable.msg_markread : 0,
                SharedConfig.archiveHidden ? tglive.fqrs.app.R.drawable.chats_pin : tglive.fqrs.app.R.drawable.chats_unpin,
        };
        CharSequence[] items = new CharSequence[]{
                hasUnread ? LocaleController.getString(tglive.fqrs.app.R.string.MarkAllAsRead) : null,
                SharedConfig.archiveHidden ? LocaleController.getString(tglive.fqrs.app.R.string.PinInTheList) : LocaleController.getString(tglive.fqrs.app.R.string.HideAboveTheList)
        };
    ...
    public boolean showChatPreview(DialogCell cell) {
        ...
        if (hasFolders) {
            ...
            for (int i = 0; i < foldersCount; ++i) {
                ...
                folderItem.setTextAndIcon(title, 0, new FolderDrawable(getContext(), tglive.fqrs.app.R.drawable.msg_folders, folder.color));
            ...
            if (linearLayout.getChildCount() <= 0) {
                ...
                gap.setTag(tglive.fqrs.app.R.id.fit_width_tag, 1);
                ActionBarMenuSubItem backItem = new ActionBarMenuSubItem(getParentActivity(), backButtonAtTop, !backButtonAtTop);
                backItem.setTextAndIcon(LocaleController.getString(tglive.fqrs.app.R.string.Back), tglive.fqrs.app.R.drawable.ic_ab_back);
        ...
        previewMenu[0] = new ActionBarPopupWindow.ActionBarPopupWindowLayout(getParentActivity(), tglive.fqrs.app.R.drawable.popup_fixed_alert2, getResourceProvider(), flags);
        ...
        if (hasFolders) {
            ...
            addToFolderItem.setTextAndIcon(LocaleController.getString(tglive.fqrs.app.R.string.FilterAddTo), tglive.fqrs.app.R.drawable.msg_addfolder);
        ...
        if (cell.getHasUnread()) {
            markAsUnreadItem.setTextAndIcon(LocaleController.getString(tglive.fqrs.app.R.string.MarkAsRead), tglive.fqrs.app.R.drawable.msg_markread);
        } else {
            markAsUnreadItem.setTextAndIcon(LocaleController.getString(tglive.fqrs.app.R.string.MarkAsUnread), tglive.fqrs.app.R.drawable.msg_markunread);
        }
        ...
        if (hasPinAction[0]) {
            ...
            if (isDialogPinned(dialog)) {
                unpinItem.setTextAndIcon(LocaleController.getString(tglive.fqrs.app.R.string.UnpinMessage), tglive.fqrs.app.R.drawable.msg_unpin);
            } else {
                unpinItem.setTextAndIcon(LocaleController.getString(tglive.fqrs.app.R.string.PinMessage), tglive.fqrs.app.R.drawable.msg_pin);
            }
        ...
        if (!DialogObject.isUserDialog(dialogId) || !UserObject.isUserSelf(getMessagesController().getUser(dialogId))) {
            ...
            if (!getMessagesController().isDialogMuted(dialogId, 0)) {
                muteItem.setTextAndIcon(LocaleController.getString(tglive.fqrs.app.R.string.Mute), tglive.fqrs.app.R.drawable.msg_mute);
            } else {
                muteItem.setTextAndIcon(LocaleController.getString(tglive.fqrs.app.R.string.Unmute), tglive.fqrs.app.R.drawable.msg_unmute);
            }
        ...
        deleteItem.setTextAndIcon(LocaleController.getString(tglive.fqrs.app.R.string.Delete), tglive.fqrs.app.R.drawable.msg_delete);
    ...
    private void updateStoriesPosting() {
        ...
        if (initialDialogsType == DIALOGS_TYPE_WIDGET) {
            floatingButton.setImageResource(tglive.fqrs.app.R.drawable.floating_check);
            floatingButtonContainer.setContentDescription(LocaleController.getString(tglive.fqrs.app.R.string.Done));
        } else if (storiesEnabled) {
            floatingButton.setAnimation(tglive.fqrs.app.R.raw.write_contacts_fab_icon_camera, 56, 56);
            floatingButtonContainer.setContentDescription(LocaleController.getString(tglive.fqrs.app.R.string.AccDescrCaptureStory));
            ...
            floatingButton.setAnimation(tglive.fqrs.app.R.raw.write_contacts_fab_icon, 52, 52);
            floatingButtonContainer.setContentDescription(LocaleController.getString(tglive.fqrs.app.R.string.NewMessageTitle));

            if (floatingButton2 != null) {
                floatingButton2.setImageResource(tglive.fqrs.app.R.drawable.filled_premium_camera);
                floatingButton2Container.setContentDescription(LocaleController.getString(tglive.fqrs.app.R.string.AccDescrCaptureStory));
                if (floatingButtonContainer.getVisibility() == View.VISIBLE) {
                    floatingButton2Container.setVisibility(View.VISIBLE);
                }
            }
...
//            }
    ...
    private void hideActionMode(boolean animateCheck) {
        ...
        if (menuDrawable != null) {
            actionBar.setBackButtonContentDescription(LocaleController.getString(tglive.fqrs.app.R.string.AccDescrOpenMenu));
        }
        selectedDialogs.clear();
        if (menuDrawable != null) {
            menuDrawable.setRotation(0, true);
        ...
        if (action == archive || action == archive2) {
            ...
            if (newPinnedSecretCount + pinnedSecretCount > maxPinnedCount || newPinnedCount + pinnedCount - alreadyAdded > maxPinnedCount) {
                if (folderId != 0 || filter != null) {
                    AlertsCreator.showSimpleAlert(DialogsActivity.this, LocaleController.formatString("PinFolderLimitReached", tglive.fqrs.app.R.string.PinFolderLimitReached, LocaleController.formatPluralString("Chats", maxPinnedCount)));
                } else {
            ...
            if (action == pin || action == pin2) {
                ...
                if (count == 1) {
                    if (action == delete && canDeletePsaSelected) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                        builder.setTitle(LocaleController.getString(tglive.fqrs.app.R.string.PsaHideChatAlertTitle));
                        builder.setMessage(LocaleController.getString(tglive.fqrs.app.R.string.PsaHideChatAlertText));
                        builder.setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.PsaHide), (dialog1, which) -> {
                            getMessagesController().hidePromoDialog();
                            hideActionMode(false);
                        });
                        builder.setNegativeButton(LocaleController.getString(tglive.fqrs.app.R.string.Cancel), null);
    ...
    private void updateCounters(boolean hide) {
        ...
        if (clearItem != null) {
            if (canClearCacheCount != 0 && canClearCacheCount != count || canClearHistoryCount != 0 && canClearHistoryCount != count) {
                ...
                if (canClearCacheCount != 0) {
                    clearItem.setText(LocaleController.getString(tglive.fqrs.app.R.string.ClearHistoryCache));
                } else {
                    clearItem.setText(LocaleController.getString(tglive.fqrs.app.R.string.ClearHistory));
                }
            }
        }
        if (archiveItem != null && archive2Item != null) {
            if (canUnarchiveCount != 0) {
                final String contentDescription = LocaleController.getString(tglive.fqrs.app.R.string.Unarchive);
                archiveItem.setTextAndIcon(contentDescription, tglive.fqrs.app.R.drawable.msg_unarchive);
                archive2Item.setIcon(tglive.fqrs.app.R.drawable.msg_unarchive);
                ...
                final String contentDescription = LocaleController.getString(tglive.fqrs.app.R.string.Archive);
                archiveItem.setTextAndIcon(contentDescription, tglive.fqrs.app.R.drawable.msg_archive);
                archive2Item.setIcon(tglive.fqrs.app.R.drawable.msg_archive);
                archive2Item.setContentDescription(contentDescription);
                if (filterTabsView != null && filterTabsView.getVisibility() == View.VISIBLE) {
                    archive2Item.setVisibility(View.VISIBLE);
                    archiveItem.setVisibility(View.GONE);
        ...
        if (muteItem != null) {
            if (canUnmuteCount != 0) {
                muteItem.setIcon(tglive.fqrs.app.R.drawable.msg_unmute);
                muteItem.setContentDescription(LocaleController.getString(tglive.fqrs.app.R.string.ChatsUnmute));
            } else {
                muteItem.setIcon(tglive.fqrs.app.R.drawable.msg_mute);
                muteItem.setContentDescription(LocaleController.getString(tglive.fqrs.app.R.string.ChatsMute));
            }
        }
        if (readItem != null) {
            if (canReadCount != 0) {
                readItem.setTextAndIcon(LocaleController.getString(tglive.fqrs.app.R.string.MarkAsRead), tglive.fqrs.app.R.drawable.msg_markread);
                readItem.setVisibility(View.VISIBLE);
            } else {
                if (forumCount == 0) {
                    readItem.setTextAndIcon(LocaleController.getString(tglive.fqrs.app.R.string.MarkAsUnread), tglive.fqrs.app.R.drawable.msg_markunread);
                    readItem.setVisibility(View.VISIBLE);
                } else {
        ...
        if (pinItem != null && pin2Item != null) {
            if (canPinCount != 0) {
                pinItem.setIcon(tglive.fqrs.app.R.drawable.msg_pin);
                pinItem.setContentDescription(LocaleController.getString(tglive.fqrs.app.R.string.PinToTop));
                pin2Item.setText(LocaleController.getString(tglive.fqrs.app.R.string.DialogPin));
            } else {
                pinItem.setIcon(tglive.fqrs.app.R.drawable.msg_unpin);
                pinItem.setContentDescription(LocaleController.getString(tglive.fqrs.app.R.string.UnpinFromTop));
                pin2Item.setText(LocaleController.getString(tglive.fqrs.app.R.string.DialogUnpin));
            }
        }
    }
    ...
    private boolean validateSlowModeDialog(long dialogId) {
        ...
        if (chat != null && !ChatObject.hasAdminRights(chat) && chat.slowmode_enabled) {
            AlertsCreator.showSimpleAlert(DialogsActivity.this, LocaleController.getString(tglive.fqrs.app.R.string.Slowmode), LocaleController.getString(tglive.fqrs.app.R.string.SlowmodeSendError));
            return false;
        }
        return true;
    }
    ...
    private void showOrUpdateActionMode(long dialogId, View cell) {
        ...
        if (actionBar.isActionModeShowed()) {
            ...
            if (menuDrawable != null) {
                actionBar.setBackButtonContentDescription(LocaleController.getString(tglive.fqrs.app.R.string.AccDescrGoBack));
            }
            if (getPinnedCount() > 1) {
                if (viewPages != null) {
                    for (int a = 0; a < viewPages.length; a++) {
    ...
    private void updateSelectedCount() {
        if (commentView != null) {
            if (selectedDialogs.isEmpty()) {
                if (initialDialogsType == 3 && selectAlertString == null) {
                    actionBar.setTitle(LocaleController.getString(tglive.fqrs.app.R.string.ForwardTo));
                } else {
                    actionBar.setTitle(LocaleController.getString(tglive.fqrs.app.R.string.SelectChat));
                }
        ...
        writeButton.setResourceId(isNextButton ? tglive.fqrs.app.R.drawable.msg_arrow_forward : tglive.fqrs.app.R.drawable.attach_send);
    }
    ...
    private boolean showSuggestion(String suggestion) {
        if ("AUTOARCHIVE_POPULAR".equals(suggestion)) {
            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
            builder.setTitle(LocaleController.getString(tglive.fqrs.app.R.string.HideNewChatsAlertTitle));
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.getString(tglive.fqrs.app.R.string.HideNewChatsAlertText)));
            builder.setNegativeButton(LocaleController.getString(tglive.fqrs.app.R.string.Cancel), null);
            builder.setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.GoToSettings), (dialog, which) -> {
...
//            }
        ...
        if (addToGroupAlertString == null && checkCanWrite) {
            if (DialogObject.isChatDialog(dialogId)) {
                ...
                if (ChatObject.isChannel(chat) && !chat.megagroup && ((cantSendToChannels || !ChatObject.isCanWriteToChannel(-dialogId, currentAccount)) || hasPoll == 2 || hasPoll == 3)) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    builder.setTitle(LocaleController.getString(tglive.fqrs.app.R.string.SendMessageTitle));
                    if (hasPoll == 3) {
                        builder.setMessage(LocaleController.getString(tglive.fqrs.app.R.string.TodoCantForward));
                    } else if (hasPoll == 2) {
                        builder.setMessage(LocaleController.getString(tglive.fqrs.app.R.string.PublicPollCantForward));
                    } else {
                        builder.setMessage(LocaleController.getString(tglive.fqrs.app.R.string.ChannelCantSendMessage));
                    }
                    builder.setNegativeButton(LocaleController.getString(tglive.fqrs.app.R.string.OK), null);
                    showDialog(builder.create());
                    return false;
                }
                ...
                builder.setTitle(LocaleController.getString(tglive.fqrs.app.R.string.SendMessageTitle));
                if (hasPoll == 3) {
                    builder.setMessage(LocaleController.getString(tglive.fqrs.app.R.string.TodoCantForwardSecretChat));
                } else if (hasPoll != 0) {
                    builder.setMessage(LocaleController.getString(tglive.fqrs.app.R.string.PollCantForwardSecretChat));
                } else {
                    builder.setMessage(LocaleController.getString(tglive.fqrs.app.R.string.InvoiceCantForwardSecretChat));
                }
                builder.setNegativeButton(LocaleController.getString(tglive.fqrs.app.R.string.OK), null);
                showDialog(builder.create());
                return false;
    ...
    public void didSelectResult(final long dialogId, long topicId, boolean useAlert, final boolean param, TopicsFragment topicsFragment) {
        ...
        if (initialDialogsType == DIALOGS_TYPE_IMPORT_HISTORY_GROUPS || initialDialogsType == DIALOGS_TYPE_IMPORT_HISTORY_USERS || initialDialogsType == DIALOGS_TYPE_IMPORT_HISTORY) {
            ...
            if (DialogObject.isEncryptedDialog(dialogId)) {
                ...
                title = LocaleController.getString(tglive.fqrs.app.R.string.SendMessageTitle);
                message = LocaleController.formatStringSimple(selectAlertString, UserObject.getUserName(user));
                buttonText = LocaleController.getString(tglive.fqrs.app.R.string.Send);
            } else if (DialogObject.isUserDialog(dialogId)) {
                if (dialogId == getUserConfig().getClientUserId()) {
                    title = LocaleController.getString(tglive.fqrs.app.R.string.SendMessageTitle);
                    message = LocaleController.formatStringSimple(selectAlertStringGroup, LocaleController.getString(tglive.fqrs.app.R.string.SavedMessages));
                    buttonText = LocaleController.getString(tglive.fqrs.app.R.string.Send);
                } else {
                    TLRPC.User user = getMessagesController().getUser(dialogId);
                ...
                if (addToGroupAlertString != null) {
                    title = LocaleController.getString(tglive.fqrs.app.R.string.AddToTheGroupAlertTitle);
                    message = LocaleController.formatStringSimple(addToGroupAlertString, chatTitle);
                    buttonText = LocaleController.getString(tglive.fqrs.app.R.string.Add);
                } else {
                    title = LocaleController.getString(tglive.fqrs.app.R.string.SendMessageTitle);
    ...
    private void showSendToBotAlert(TLRPC.User user, Runnable ok, Runnable cancel) {
        ...
        showDialog(
                new AlertDialog.Builder(getContext())
                        .setTitle(LocaleController.formatString(tglive.fqrs.app.R.string.AreYouSureSendChatToBotTitle, UserObject.getFirstName(user), UserObject.getFirstName(bot)))
                        .setMessage(TextUtils.concat(
                                AndroidUtilities.replaceTags(LocaleController.formatString(tglive.fqrs.app.R.string.AreYouSureSendChatToBotMessage, UserObject.getFirstName(user), UserObject.getFirstName(bot)))
                        ))
                        .setPositiveButton(LocaleController.formatString("Send", tglive.fqrs.app.R.string.Send), (di, p) -> ok.run())
                        .setNegativeButton(LocaleController.formatString("Cancel", tglive.fqrs.app.R.string.Cancel), (di, p) -> {
                            if (cancel != null) {
                                cancel.run();
                            }
                        }).create()
    ...
    private void showSendToBotAlert(TLRPC.Chat chat, Runnable ok, Runnable cancel) {
        ...
        showDialog(
                new AlertDialog.Builder(getContext())
                        .setTitle(LocaleController.formatString(tglive.fqrs.app.R.string.AreYouSureSendChatToBotTitle, chat.title, UserObject.getFirstName(bot)))
                        .setMessage(TextUtils.concat(
                                AndroidUtilities.replaceTags(LocaleController.formatString(tglive.fqrs.app.R.string.AreYouSureSendChatToBotMessage, chat.title, UserObject.getFirstName(bot))),
                                (
                                        ...
                                        TextUtils.concat("\n\n", AndroidUtilities.replaceTags(
                                                (requestPeerType.bot_admin_rights == null) ?
                                                        LocaleController.formatString(tglive.fqrs.app.R.string.AreYouSureSendChatToBotAdd, UserObject.getFirstName(bot), chat.title) :
                                                        LocaleController.formatString(tglive.fqrs.app.R.string.AreYouSureSendChatToBotAddRights, UserObject.getFirstName(bot), chat.title, RequestPeerRequirementsCell.rightsToString(requestPeerType.bot_admin_rights, isChannel))
                                        )) : ""
                        ))
                        .setPositiveButton(LocaleController.formatString("Send", tglive.fqrs.app.R.string.Send), (di, p) -> ok.run())
                        .setNegativeButton(LocaleController.formatString("Cancel", tglive.fqrs.app.R.string.Cancel), (di, p) -> {
    ...
    private boolean onSendLongClick(View view) {
        ...
        sendWithoutSound.setTextAndIcon(LocaleController.getString(tglive.fqrs.app.R.string.SendWithoutSound), tglive.fqrs.app.R.drawable.input_notify_off);
        ...
        if (canSchedule) {
            ...
            scheduleMessages.setTextAndIcon(LocaleController.getString(tglive.fqrs.app.R.string.ScheduleMessage), tglive.fqrs.app.R.drawable.msg_calendar2);
        ...
        sendPopupWindow.setAnimationStyle(tglive.fqrs.app.R.style.PopupContextAnimation2);
...
//            arrayList.add(new ThemeDescription(commentView, ThemeDescription.FLAG_IMAGECOLOR, new Class[]{ChatActivityEnterView.class}, new String[]{"sendButton"}, null, null, null, Theme.key_chat_messagePanelSend));
    ...
    private void updateFloatingButtonColor() {
        ...
        if (floatingButtonContainer != null) {
            ...
            if (Build.VERSION.SDK_INT < 21) {
                Drawable shadowDrawable = ContextCompat.getDrawable(getParentActivity(), tglive.fqrs.app.R.drawable.floating_shadow).mutate();
                shadowDrawable.setColorFilter(new PorterDuffColorFilter(0xff000000, PorterDuff.Mode.MULTIPLY));
                CombinedDrawable combinedDrawable = new CombinedDrawable(shadowDrawable, drawable, 0, 0);
                combinedDrawable.setIconSize(dp(56), dp(56));
                drawable = combinedDrawable;
...
//            }
    ...
    public List<FloatingDebugController.DebugItem> onGetDebugItems() {
        return Arrays.asList(
                new FloatingDebugController.DebugItem(LocaleController.getString(tglive.fqrs.app.R.string.DebugDialogsActivity)),
                new FloatingDebugController.DebugItem(LocaleController.getString(tglive.fqrs.app.R.string.ClearLocalDatabase), () -> {
                    getMessagesStorage().clearLocalDatabase();
                    Toast.makeText(getContext(), LocaleController.getString(tglive.fqrs.app.R.string.DebugClearLocalDatabaseSuccess), Toast.LENGTH_SHORT).show();
                }),
                new FloatingDebugController.DebugItem(LocaleController.getString(tglive.fqrs.app.R.string.DebugClearSendMessageAsPeers), () -> getMessagesController().clearSendAsPeers())
        );
    }
...
//            }
        ...
        searchViewPager.dialogsSearchAdapter.setDelegate(new DialogsSearchAdapter.DialogsSearchAdapterDelegate() {
            ...
            public void needRemoveHint(long did) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                builder.setTitle(LocaleController.getString(tglive.fqrs.app.R.string.ChatHintsDeleteAlertTitle));
                builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("ChatHintsDeleteAlert", tglive.fqrs.app.R.string.ChatHintsDeleteAlert, ContactsController.formatName(user.first_name, user.last_name))));
                builder.setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.StickersRemove), (dialogInterface, i) -> getMediaDataController().removePeer(did));
                builder.setNegativeButton(LocaleController.getString(tglive.fqrs.app.R.string.Cancel), null);
            ...
            public void needClearList() {
                ...
                if (searchViewPager.dialogsSearchAdapter.isSearchWas() && searchViewPager.dialogsSearchAdapter.isRecentSearchDisplayed()) {
                    builder.setTitle(LocaleController.getString(tglive.fqrs.app.R.string.ClearSearchAlertPartialTitle));
                    ...
                    builder.setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.Clear), (dialogInterface, i) -> {
                        searchViewPager.dialogsSearchAdapter.clearRecentSearch();
                    });
                } else {
                    builder.setTitle(LocaleController.getString(tglive.fqrs.app.R.string.ClearSearchAlertTitle));
                    builder.setMessage(LocaleController.getString(tglive.fqrs.app.R.string.ClearSearchAlert));
                    builder.setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.ClearButton), (dialogInterface, i) -> {
        ...
        searchViewPager.botsSearchListView.setOnItemLongClickListener((view, position) -> {
            ...
            if (obj instanceof TLRPC.User) {
                ...
                new AlertDialog.Builder(getContext(), resourceProvider)
                    .setTitle(getString(tglive.fqrs.app.R.string.AppsClearSearch))
                    .setMessage(formatString(tglive.fqrs.app.R.string.AppsClearSearchAlert, "\"" + UserObject.getUserName(user) + "\""))
                    .setNegativeButton(LocaleController.getString(tglive.fqrs.app.R.string.Cancel), null)
                    .setPositiveButton(LocaleController.getString(tglive.fqrs.app.R.string.Remove), (di, w) -> {
        ...
        if (imageUpdater == null) {
            ...
            imageUpdater.setDelegate(new ImageUpdater.ImageUpdaterDelegate() {
                ...
                public void didStartUpload(boolean fromAvatarConstructor, boolean isVideo) {
                    ...
                    bulletinLayout.setButton(new Bulletin.UndoButton(getContext(), true, resourceProvider).setText(getString(tglive.fqrs.app.R.string.ViewAction)).setUndoAction(this::openAvatarInProfile));
                    bulletinLayout.getButton().setVisibility(View.GONE);
                    bulletinLayout.textView.setText(getString(isVideo ? tglive.fqrs.app.R.string.YourProfileVideoUploading : tglive.fqrs.app.R.string.YourProfilePhotoUploading), true);
                    ...
                    AndroidUtilities.runOnUIThread(() -> {
                        if (photo != null || video != null || emojiMarkup != null) {
                            ...
                            avatarUploadingRequest = getConnectionsManager().sendRequest(req, (response, error) -> AndroidUtilities.runOnUIThread(() -> {
                                ...
                                if (uploadingAvatarBulletin != null) {
                                    final Bulletin.ProgressLayout layout = (Bulletin.ProgressLayout) uploadingAvatarBulletin.getLayout();
                                    layout.textView.setText(getString(isVideo ? tglive.fqrs.app.R.string.YourProfileVideoDone : tglive.fqrs.app.R.string.YourProfilePhotoDone), true);
