...
import static tglive.fqrs.app.AndroidUtilities.touchSlop;
...
import tglive.fqrs.app.camera.CameraController;
...
import tglive.fqrs.app.ui.Components.FilterShaders;
import tglive.fqrs.app.ui.Components.GestureDetectorFixDoubleTap;
...
import tglive.fqrs.app.ui.Components.PhotoFilterBlurControl;
import tglive.fqrs.app.ui.Components.PhotoFilterCurvesControl;
import tglive.fqrs.app.ui.Components.PhotoFilterView;
...
import tglive.fqrs.app.ui.Components.VideoEditTextureView;
import tglive.fqrs.app.ui.Components.WaveDrawable;
import tglive.fqrs.app.ui.Components.ZoomControlView;
...
import tglive.fqrs.app.ui.Stories.PeerStoriesView;
import tglive.fqrs.app.ui.Stories.StoriesController;
import tglive.fqrs.app.ui.Stories.StoryViewer;
import tglive.fqrs.app.ui.Stories.StoryWaveEffectView;
      ...
      protected boolean ignoreTouches(float x, float y) {
        ...
        for (int i = 0; i < paintView.entitiesView.getChildCount(); ++i) {
          ...
          if (view instanceof EntityView) {
            tglive.fqrs.app.ui.Components.Rect rect = ((EntityView) view).getSelectionBounds();
...
//        }
      ...
      previewButtons.setButtonVisible(PreviewButtons.BUTTON_CROP, BuildVars.DEBUG_VERSION && outputEntry != null && !outputEntry.isRepostMessage && !outputEntry.isCollage());
