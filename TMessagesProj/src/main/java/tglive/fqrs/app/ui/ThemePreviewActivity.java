...
import tglive.fqrs.app.ui.Cells.PatternCell;
...
import tglive.fqrs.app.ui.Components.CircularProgressDrawable;
import tglive.fqrs.app.ui.Components.ColorPicker;
...
import tglive.fqrs.app.ui.Components.GestureDetector2;
import tglive.fqrs.app.ui.Components.HintView;
import tglive.fqrs.app.ui.Components.LayoutHelper;
import tglive.fqrs.app.ui.Components.MotionBackgroundDrawable;
...
import tglive.fqrs.app.ui.Components.WallpaperCheckBoxView;
import tglive.fqrs.app.ui.Components.WallpaperParallaxEffect;
import tglive.fqrs.app.ui.Stories.recorder.PreviewView;
import tglive.fqrs.app.ui.Stories.recorder.SliderView;
...
//            }, 200);
    ...
    if (messagesAdapter.showSecretMessages) {
      actionBar2.setTitle("TG Live Chat");
      ...
      if (screenType == SCREEN_TYPE_CHANGE_BACKGROUND) {
        ...
        if (dialogId == 0 && (BuildVars.DEBUG_VERSION && Theme.getActiveTheme().getAccent(false) != null || currentWallpaper instanceof WallpapersListActivity.ColorWallpaper && !Theme.DEFAULT_BACKGROUND_SLUG.equals(((WallpapersListActivity.ColorWallpaper) currentWallpaper).slug) || currentWallpaper instanceof TLRPC.TL_wallPaper)) {
