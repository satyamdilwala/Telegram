...
import tglive.fqrs.app.MrzRecognizer;
...
import tglive.fqrs.app.SecureDocument;
import tglive.fqrs.app.SecureDocumentKey;
...
import tglive.fqrs.app.ui.Cells.TextDetailSettingsCell;
...
import tglive.fqrs.app.ui.Components.EmptyTextProgressView;
import tglive.fqrs.app.ui.Components.HintEditText;
    ...
    private void createIdentityInterface(final Context context) {
        ...
        if (currentDocumentsType != null) {
            ...
            scanDocumentCell.setOnClickListener(v -> {
                ...
                CameraScanActivity fragment = new CameraScanActivity(tglive.fqrs.app.ui.CameraScanActivity.TYPE_MRZ);
