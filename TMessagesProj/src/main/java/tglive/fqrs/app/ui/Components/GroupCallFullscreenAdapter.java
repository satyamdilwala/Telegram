...
public class GroupCallFullscreenAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public class GroupCallUserCell extends FrameLayout implements GroupCallStatusIcon.Callback {
        ...
        tglive.fqrs.app.ui.Cells.GroupCallUserCell.AvatarWavesDrawable avatarWavesDrawable = new tglive.fqrs.app.ui.Cells.GroupCallUserCell.AvatarWavesDrawable(AndroidUtilities.dp(26), AndroidUtilities.dp(29));
