...
//  public static int saveToGalleryFlags;
    ...
    synchronized (sync) {
      ...
      try {
        ...
        if (pendingAppUpdate != null) {
          ...
          if (pendingAppUpdateBuildVersion != updateVersion || pendingAppUpdate.version == null || updateVersionString.compareTo(pendingAppUpdate.version) >= 0 || BuildVars.DEBUG_VERSION) {
      ...
      onlyLocalInstantView = preferences.getBoolean("onlyLocalInstantView", BuildVars.DEBUG_VERSION);
  ...
  public static boolean isAppUpdateAvailable() {
    if (pendingAppUpdate == null || pendingAppUpdate.document == null || !false) {
      return false;
    }
    int currentVersion;
    try {
  ...
  public static boolean canBlurChat() {
    return getDevicePerformanceClass() >= (Build.VERSION.SDK_INT >= 31 ? PERFORMANCE_CLASS_AVERAGE : PERFORMANCE_CLASS_HIGH) || BuildVars.DEBUG_VERSION;
  }
