...
-keep class tglive.fqrs.app.* { *; }
-keep class tglive.fqrs.app.camera.* { *; }
-keep class tglive.fqrs.app.secretmedia.* { *; }
-keep class tglive.fqrs.app.support.* { *; }
-keep class tglive.fqrs.app.support.* { *; }
-keep class tglive.fqrs.app.time.* { *; }
-keep class tglive.fqrs.app.video.* { *; }
-keep class tglive.fqrs.app.voip.* { *; }
-keep class tglive.fqrs.app.SQLite.** { *; }
-keep class tglive.fqrs.app.tgnet.ConnectionsManager { *; }
-keep class tglive.fqrs.app.tgnet.NativeByteBuffer { *; }
-keep class tglive.fqrs.app.tgnet.RequestTimeDelegate { *; }
-keep class tglive.fqrs.app.tgnet.RequestDelegate { *; }
-keep class com.google.android.exoplayer2.ext.** { *; }
-keep class com.google.android.exoplayer2.extractor.FlacStreamMetadata { *; }
-keep class com.google.android.exoplayer2.metadata.flac.PictureFrame { *; }
-keep class com.google.android.exoplayer2.decoder.SimpleDecoderOutputBuffer { *; }
-keep class tglive.fqrs.app.ui.Stories.recorder.FfmpegAudioWaveformLoader { *; }
